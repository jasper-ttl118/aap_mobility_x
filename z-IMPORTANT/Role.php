...
/*
    AFTER THE FRESH CLONE OF THIS REPOSITORY, DO THE FOLLOWING:
        (or running "composer install" again):
    1. Delete the "vendor" folder (if it's included)
    2. Run "composer install" in the terminal
    3. Go to "/vendor/spatie/laravel-permission/src/Models" directory
    4. Paste and replace this file (along with "Permission.php")
    5. Run Migrations
    6. Run Department Seeder and Inital Seeder
*/
