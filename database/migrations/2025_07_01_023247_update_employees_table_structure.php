...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $newColumnsToAdd = [
            ...
            'marriage_certificate_path' => 'string_nullable',
            'parents_birth_certificate_path' => 'string_nullable',
            'sss_updated' => 'boolean_nullable',
            'philhealth_updated' => 'boolean_nullable',
            'pagibig_updated' => 'boolean_nullable',
            'pagibig_mdf_path' => 'string_nullable',
            ...
            'children_birth_certificates_path' => 'string_nullable',
            'employee_children_details' => 'text_nullable',
            'parents_birth_certificate_dependents_path' => 'string_nullable',
            'employee_parents_details' => 'text_nullable',
            'employee_blood_type' => 'string_nullable',
            'emergency_contact_1_name' => 'string_nullable',
            'emergency_contact_1_relationship' => 'string_nullable',
            'emergency_contact_1_number' => 'string_nullable',
            'emergency_contact_1_address' => 'text_nullable',
            'emergency_contact_2_name' => 'string_nullable',
            'emergency_contact_2_relationship' => 'string_nullable',
            'emergency_contact_2_number' => 'string_nullable',
            'emergency_contact_2_address' => 'text_nullable',
        ];
