        ...
        <div class=" rounded-md border-2 border-gray-100 bg-white shadow-lg -mt-4">
            <div class="flex flex-col justify-between">
                ...
                <div class="flex flex-col items-center p-5">
                    <div class="flex flex-col w-full border-2 border-blue-400 rounded-lg justify-center items-center">
                        <div class="flex flex-row w-full h-auto gap-x-5 justify-center items-center">
                            <div class="w-full h-[200px] flex flex-row gap-x-3 ">
                                <div class="flex flex-col w-[20%] h-full items-center justify-center gap-y-2">
                                ...
                                <div class="flex flex-row w-[80%] h-full py-4 pr-4 gap-10 justify-center items-center">
                                    {{-- Left --}}
                                    <div class="flex flex-col w-[50%] h-full items-start gap-y-5">
                                        {{-- First Row --}}
                                    ...
                                    {{-- Right --}}
                                    <div class="flex flex-col w-[50%] h-full gap-y-3">
                        ...
                        {{-- Line --}}
                        <div class="flex border border-blue-400 w-[90%] rounded-xl"></div>
                        {{-- Second Row --}}
                        <div class="flex flex-row w-full h-auto gap-x-5 justify-center items-center">
                            <div class="w-full h-[200px] flex flex-row gap-x-3 justify-center items-center">
                                <div class="flex flex-row w-full h-full py-4 px-5 gap-10 justify-center items-center ">
                                    {{-- Left --}}
                                    <div class="flex flex-col w-auto h-full items-end gap-y-5">
                                        {{-- First Column --}}
                                        <div class="text-[#071d49] flex flex-col items-end gap-x-1 justify-between w-full gap-y-5 ">
                                            <div class="flex flex-col justify-center items-center">
                                    ...
                                    {{-- Line --}}
                                    <div class="flex border border-blue-400 h-[170px] rounded-xl"></div>
                                    <div class="flex flex-col w-auto h-full items-start gap-y-5 ">
                                        {{-- Second Column --}}
                                    ...
                                    <div class="flex flex-col w-auto h-full items-start gap-y-5 ">
                                        <div class="text-[#071d49] flex flex-row items-start gap-x-1 justify-between w-full gap-y-5">
                                            ...
                                            <div class="flex flex-col w-full h-full justify-start items-start gap-y-5">
                                                ...
                                                <div class="flex flex-col justify-center items-start">
                                                    <label class="text-[#071d49] text-sm font-inter uppercase" name="fullName">AAP MAIN</label>
                        ...
                        <div class="flex flex-row w-full h-auto gap-x-5 justify-center items-center">
                            <div class="w-full h-[200px] flex flex-row gap-x-3 justify-center items-center">
                                <div class="flex flex-row w-full h-full py-4 px-5 gap-10 justify-center items-center ">
                                    {{-- Left --}}
                                    <div class="flex flex-row w-full h-auto items-center gap-y-5 gap-x-7 px-8">
                                        {{-- First Column --}}
