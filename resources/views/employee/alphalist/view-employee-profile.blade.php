            ...
            <div class="flex flex-col justify-between mt-3">
                ...
                <div x-data="{openSection:'basicInfo'}" class="p-5 ">
                    ...
                    <div @click="openSection = (openSection === 'basicInfo' ? null : 'basicInfo')" class="cursor-pointer border-blue-400 border rounded-lg p-5">
                        ...
                        <div x-show="openSection === 'basicInfo'" x-transition x-cloak class="flex flex-col  w-full h-full items-center justify-evenly gap-y-2 gap-x-3 pt-3">
                            <div class="flex flex-row w-[85%] gap-x-5">
                                <div class="flex flex-row lg:flex-col w-full lg:w-[25%] justify-center items-center gap-y-5 gap-x-3">
                                ...
                                <div class="flex flex-col w-[75%] h-full justify-center items-center gap-y-4">
                            ...
                            {{-- Address --}}
                            <div class="flex flex-col w-[90%] gap-y-1">
                                <div class="text-[#071d49] flex flex-col items-start gap-x-1 justify-start w-full">
                                    <label class="text-sm font-inter font-medium leading-relaxed tracking-wide text-blue-800 bg-blue-200 w-full px-5">Complete Home Address (Present) </label>
                                    <div class="flex flex-row w-full px-10 justify-between items-start">
                                        <table class="w-full border-collapse px-0">
                                            <tr class="">
                                                <td class="pb-2 px-2 align-top w-[10%]">
                                                ...
                                                <td class="pb-2 px-2 align-top w-[20%]">
                                                    <div class="flex flex-col w-full">
                        ...
                        <div x-show="openSection === 'contactInfo'" x-transition x-cloak class="flex flex-col w-full h-full items-center gap-y-5 pt-3">
                            ...
                            <div class="flex flex-col lg:flex-row w-full lg:w-[80%] justify-between gap-y-5 lg:gap-x-10">
                                <div class="flex flex-col w-full lg:w-1/3 gap-y-1 items-start">
                                    <label class="text-sm font-inter font-medium leading-relaxed tracking-wide text-blue-400">Personal Email Address:</label>
                                    <label class="text-[#071d49] text-xs lg:text-sm font-inter">{{ $employee->employee_personal_email ?? 'N/A' }}</label>
                                </div>

                                <div class="flex flex-col w-full lg:w-1/3 gap-y-1 items-start">
                                    <label class="text-xs font-inter font-medium leading-relaxed tracking-wide text-blue-400">Personal Mobile Number</label>
                                    <label class="text-[#071d49] text-xs lg:text-sm font-inter uppercase">{{ $employee->employee_contact_no1 ?? 'N/A' }}</label>
                                </div>

                                <div class="flex flex-col w-full lg:w-1/3 gap-y-1 items-start">
                                    <label class="text-xs font-inter font-medium leading-relaxed tracking-wide text-blue-400">Mobile No. 2
                                        <label for="" class="text-gray-300">(Optional)</label>
                                    </label>
                            ...
                            <div class="flex flex-col lg:flex-row w-full lg:w-[80%] justify-between gap-y-5 lg:gap-x-10">
                                <div class="flex flex-col w-full lg:w-1/3 gap-y-1 items-start">
                                    <label class="text-xs font-inter font-medium leading-relaxed tracking-wide text-blue-400">Viber Mobile Number</label>
                                    <label class="text-[#071d49] text-xs lg:text-sm font-inter uppercase">{{ $employee->employee_viber_number ?? 'N/A' }}</label>
                                </div>

                                <div class="flex flex-col w-full lg:w-1/3 gap-y-1 items-start">
                                    <label class="text-xs font-inter font-medium leading-relaxed tracking-wide text-blue-400">Company Mobile Number</label>
                                    <label class="text-[#071d49] text-xs lg:text-sm font-inter uppercase">{{ $employee->employee_company_number ?? 'N/A' }}</label>
                                </div>

                                <div class="flex flex-col w-full lg:w-1/3 gap-y-1 items-start">
                                    <label class="text-xs font-inter font-medium leading-relaxed tracking-wide text-blue-400">Company Email Address</label>
                    ...
                    <div @click="openSection = (openSection === 'educjobInfo' ? null : 'educjobInfo')" class="cursor-pointer border-blue-400 border rounded-lg p-5">
                        ...
                        <div x-show="openSection === 'educjobInfo'" x-transition x-cloak class="flex flex-col lg:flex-row w-full h-full items-center justify-evenly gap-x-5 gap-y-2 pt-3">
                            <div class="flex flex-col w-full lg:w-[45%] h-full items-center gap-y-5 ">
                                {{-- first Column --}}
                                <div class="text-[#071d49] flex flex-col items-start gap-x-1 justify-between w-full gap-y-2">
                                    <div class="flex flex-col w-full h-full justify-between items-start gap-y-2 lg:gap-y-5">
                                        <div class="flex flex-col w-full">
                                            <label class="text-sm font-inter font-medium leading-relaxed tracking-wide text-blue-800 bg-blue-200 w-full px-5">Tertiary:</label>
                                            ...
                                            <div class="flex flex-row w-full justify-between items-start">
                                                <div class="flex flex-col justify-center items-start">
                                                    <label class="text-xs font-inter font-medium leading-relaxed tracking-wide text-blue-400">GPA</label>
                                                    <label class="text-[#071d49] text-xs lg:text-sm font-inter uppercase" name="fullName">TEST</label>
                                                </div>
                                                <div class="flex flex-col justify-center items-start">
                                                    <label class="text-xs font-inter font-medium leading-relaxed tracking-wide text-blue-400">HONORS</label>
                                                    <label class="text-[#071d49] text-xs lg:text-sm font-inter uppercase" name="fullName">TEST</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="flex flex-col w-full">
                                            <label class="text-sm font-inter font-medium leading-relaxed tracking-wide text-blue-800 bg-blue-200 w-full px-5">Secondary:</label>
                                            <div class="flex flex-row w-full justify-between items-start">
                                                <div class="flex flex-col justify-center items-start">
                                                    <label class="text-xs font-inter font-medium leading-relaxed tracking-wide text-blue-400">School Attended</label>
                                                    <label class="text-[#071d49] text-xs lg:text-sm font-inter uppercase" name="fullName">TEST</label>
                                                ...
                                                <div class="flex flex-col justify-center items-start">
                                                    <label class="text-xs font-inter font-medium leading-relaxed tracking-wide text-blue-400">Years Attended</label>
                                                    <label class="text-[#071d49] text-xs lg:text-sm font-inter uppercase" name="fullName">TEST</label>
                                                </div>
                                                <div class="flex flex-col justify-center items-start">
                                                    <label class="text-xs font-inter font-medium leading-relaxed tracking-wide text-blue-400">GPA</label>
                                                ...
                                                <div class="flex flex-col justify-center items-start">
                                                    <label class="text-xs font-inter font-medium leading-relaxed tracking-wide text-blue-400">AWARDS</label>
                                                    <label class="text-[#071d49] text-xs lg:text-sm font-inter uppercase" name="fullName">TEST</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="flex flex-col w-full">
                                            <label class="text-sm font-inter font-medium leading-relaxed tracking-wide text-blue-800 bg-blue-200 w-full px-5">Primary:</label>
                                            <div class="flex flex-row w-full justify-between items-start">
                                                <div class="flex flex-col justify-center items-start">
                                                    <label class="text-xs font-inter font-medium leading-relaxed tracking-wide text-blue-400">School Attended</label>
                                                    <label class="text-[#071d49] text-xs lg:text-sm font-inter uppercase" name="fullName">TEST</label>
                                                ...
                                                <div class="flex flex-col justify-center items-start">
                                                    <label class="text-xs font-inter font-medium leading-relaxed tracking-wide text-blue-400">Graduation Date</label>
                                                    <label class="text-[#071d49] text-xs lg:text-sm font-inter uppercase" name="fullName">TEST</label>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="flex border border-blue-400 h-[200px] rounded-xl hidden lg:flex"></div>
                        ...
                        <div x-show="openSection === 'dependantInfo'" x-transition x-cloak class="flex flex-col w-full h-auto items-center justify-center pt-3">
                            <div class="flex flex-col w-[95%] justify-between items-center gap-y-5">
                                <table class="w-full border-collapse">
                                    ...
                                    <tr>
                                        <td colspan="3" class="text-sm text-left px-2 font-inter font-medium leading-relaxed tracking-wide text-blue-800 bg-blue-200">
                                            Father's Information
                                        </td>
                                    </tr>
                                    ...
                                    <tr class="">
                                        <td class="pb-3 px-2 align-top w-[50%]">
                                            <div class="text-xs font-inter font-medium leading-relaxed tracking-wide text-blue-400 mb-1">Full Name</div>
                                            <div class="text-[#071d49] text-xs lg:text-sm font-inter uppercase">Test</div>
                                        </td>
                                        <td class="pb-3 px-2 align-top w-[20%]">
                                            <div class="text-xs font-inter font-medium leading-relaxed tracking-wide text-blue-400 mb-1">Age</div>
                                            <div class="text-[#071d49] text-xs lg:text-sm font-inter uppercase">Test</div>
                        ...
                        <div x-show="openSection === 'emergencyContact'" x-transition x-cloak class="flex flex-row w-full h-auto justify-center items-center pt-3">
                            <div class="hidden lg:block flex flex-col w-[95%] justify-between items-center gap-y-5">
                                <table class="w-[90%] lg:w-full border-collapse">
                                    @foreach ($employee->employeeEmergencyContacts as $contact)
                                        <tr>
                                            <td colspan="4" class="text-sm text-left px-2 font-inter font-medium leading-relaxed tracking-wide text-blue-800 bg-blue-200">
                            ...
                            <div class="block lg:hidden flex flex-col w-[95%] justify-between items-center gap-y-5">
                                <div class="bg-white overflow-hidden w-full">
                                    @foreach ($employee->employeeEmergencyContacts as $contact)
                                        <div class="text-sm text-left px-4 py-1 font-inter font-medium leading-relaxed tracking-wide text-blue-800 bg-blue-200">
                                            Emergency Contact #1
                                        </div>
