        ...
        <div class="@container/main rounded-md border-2 border-gray-100 bg-white justify-center items-center flex w-full flex-col shadow-lg -mt-4">
            <div class="flex flex-col justify-between w-full mt-3">
                ...
                <div class="flex justify-start w-full gap-x-1 text-[#071d49] text-sm px-7 pt-5">
                    ...
                    <a href="#" class="hover:underline font-semibold truncate">Edit Employee</a>
                </div>
            </div>
            ...
            <div class="mt-6 flex justify-center flex-col items-center lg:items-start w-[93%] border-b border-gray-200 pb-3">
                ...
                <p class="text-sm text-center lg:text-start text-gray-600">Update employee with their relevant information.</p>
            </div>
