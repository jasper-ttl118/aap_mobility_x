        ...
        <div class=" rounded-md border-2 border-gray-100 bg-white shadow-lg -mt-4">
             <div class="flex flex-col lg:flex-row justify-between">
                ...
                <div class="flex items-center gap-x-1 text-[#071d49] text-sm px-7 pt-5">
                    ...
                    <a href="{{ route('pending-list') }}" class="hover:underline font-semibold truncate">Pending Requests List</a>
                </div>
            ...
            <div class="flex items-center justify-between px-7 py-6">
                <div>
                    <h2 class="font-semibold text-lg text-blue-900">Check and Endorse Pending Requisition Requests</h2>
                    <p class="text-gray-900 text-sm">Check, update, and view pending requisition request details.</p>
                </div>
            </div>
