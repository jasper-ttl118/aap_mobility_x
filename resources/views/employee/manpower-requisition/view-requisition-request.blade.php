        ...
        <div class="rounded-md border-2 border-gray-100 bg-white shadow-lg -mt-4">
            <div class="flex flex-col lg:flex-row justify-between">
                ...
                <div class="flex items-center gap-x-1 text-[#071d49] text-sm px-7 pt-5">
                    ...
                    <a href="{{ route('requisition.show', $requisition->requisition_id) }}" class="hover:underline font-semibold truncate">View Requisition Form</a>
                </div>
            </div>

            <livewire:employee.manpower-requisition.view-requisition :requisition="$requisition"/>
        </div>
    </div>
</x-app-layout>