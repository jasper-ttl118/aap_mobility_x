<x-app-layout class='flex flex-row w-h-screen' :x_data="['open' => false, 'deleteUrl' => '', 'viewOpen' => false, 'employee' => new stdClass()]" navbar_selected='Employee Management'>
    ...
    <div x-data="{ selected : 'pending', open_add : false, open_delete : false, open_view : false, open_edit : false}" class="flex flex-1 flex-col ml-52 overflow-y-auto p-10 gap-7 mt-12 bg-[#f3f4f6]">
        @if (session('status'))
        ...
        <div class=" rounded-md border-2 border-gray-100 bg-white shadow-lg">
            <div class="flex h-14 border-b border-gray-200">
                ...
                <div class="flex-none w-auto border-b-2 border-blue-900 p-4 text-center">
                    <a href="{{ route('manpower-requisition') }}" class="font-semibold text-blue-900">Manpower Requisition</a>
                </div>
                <div class="flex-none w-auto p-4 text-center">
                    <a href="{{ route('vacancy-list') }}" class="text-gray-600 hover:text-blue-800 font-inter">Vacancy List</a>
                </div>
            </div>
            ...
            <div class="flex justify-between">
                ...
                <div class="flex items-center gap-x-1 text-blue-900 text-sm px-7 pt-5">
                    ...
                    <a href="#" class="hover:underline font-semibold">Manpower Requisition</a>
                </div>
