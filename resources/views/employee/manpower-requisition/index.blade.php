    ...
    <div x-data="{ selected : 'pending', open_add : false, open_delete : false, open_view : false, open_edit : false,
        ...
        <div class=" rounded-md border-2 border-gray-100 bg-white shadow-lg -mt-4">
            <div class="flex flex-col lg:flex-row justify-between">
                ...
                <div class="flex justify-start lg:justify-end px-7 pt-6">
            ...
            <div class="flex items-center justify-between px-7 py-6">
                ...
                <div class="flex items-center gap-4">
                    ...
                    class="{{ request() -> routeIs('manpower-requisition') ? 'text-white bg-[#071d49] hover:bg-[#abcae9] hover:text-[#071d49] hover:font-medium' : 'text-[#071d49] bg-[#abcae9] hover:bg-[#071d49] hover:text-white'}} flex cursor-pointer items-center gap-2 rounded-md  px-4 py-2 text-sm font-medium focus:outline-none">
            ...
            <div class="mx-7 mb-10 rounded-sm overflow-x-auto hide-scrollbar">
                {{-- Pending Table --}}
                <template x-if="selected === 'pending'">
                                    ...
                                    <td class="p-2">
                                        ...
                                        {{-- {{$employee->employee_id}} --}}
                                                ...
                                                <a @click="open_edit = true; 
                                                    window.Livewire.dispatch('loadEditRequisitionRequest', { requisition_id: {{ $pendingRequisition->requisition_id }}})
                                                    "
                                                ...
                                                <a href="javascript:void(0)"
                                                    @click="open_delete = true; Livewire.dispatch('getRequisitionId', { requisition_id: {{ $pendingRequisition->requisition_id }} });"
                ...
                {{-- Approved Table --}}
                <template x-if="selected === 'approved'">
                    <table class="w-[1000px] lg:w-full text-center text-sm text-gray-500">
                        <thead class="bg-gray-100 text-xs text-gray-700 uppercase">
                            <tr>    
                                <th scope="col" class=" py-3">Request ID</th>
                                ...
                                <tr>
                                    ...
                                    <td class="p-2">
                                        ...
                                        {{-- {{$employee->employee_id}} --}}
                                                ...
                                                <a @click="open_edit = true; 
                                                    window.Livewire.dispatch('loadEditRequisitionRequest', { requisition_id: {{ $rejectedRequisition->requisition_id }}})
                                                    "
                                                    class="cursor-pointer flex items-center gap-1 font-medium text-blue-800">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                        fill="currentColor" class="size-4">
                                                ...
                                                <a href="javascript:void(0)"
                                                    @click="open_delete = true; Livewire.dispatch('getRequisitionId', { requisition_id: {{ $rejectedRequisition->requisition_id }} });"
                                                    class="cursor-pointer flex items-center gap-1 font-medium text-red-700">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                        fill="currentColor" class="size-4">
                                                        <path fill-rule="evenodd"
