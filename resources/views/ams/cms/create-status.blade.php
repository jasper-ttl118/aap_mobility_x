        ...
        <div class="rounded-md border-2 border-gray-100 bg-white shadow-lg -mt-4">
            <div class="flex flex-col justify-between w-full">
                ...
                <div class="flex justify-start w-full gap-x-1 text-[#071d49] text-sm px-7 pt-5">
                    ...
                    <a href="/ams/cms/asset-status" class="hover:underline">Asset Status</a>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" class="w-4 h-4">
                        <path fill-rule="evenodd"
                            d="M16.28 11.47a.75.75 0 0 1 0 1.06l-7.5 7.5a.75.75 0 0 1-1.06-1.06L14.69 12 7.72 5.03a.75.75 0 0 1 1.06-1.06l7.5 7.5Z"
                            clip-rule="evenodd" />
                    </svg>
                    <a href="#" class="hover:underline font-semibold">Add Status</a>
                </div>
            </div>

            <header class="mt-5 flex justify-center flex-col items-start w-full px-10">
                <h2 class="text-2xl font-medium text-[#151847]">ADD NEW STATUS</h2>
            </header>
                    ...
                    <div class="p-10 bg-white rounded-xl space-y-8 shadow-lg">
                        <div class="gap-y-7 flex flex-col">
                            ...
                            <div class="w-full flex flex-col items-start justify-start gap-y-1">
                                <h2 class="text-lg font-bold mb-2 text-[#071d49]">Status Details</h2>
                                <p class="text-sm text-gray-600 leading-tight"><em>Define a new asset status with a brief description.</em></p>
                            </div>

                            <!-- Status Name -->
                            <div class="w-full">
                                <label class="block text-sm font-medium text-gray-700">Status Name</label>
                                <input type="text" placeholder="e.g., Available, Lost, In Use"
                            ...
                            <div class="w-full">
                                ...
                                <textarea rows="3" placeholder="Brief explanation of the status"
