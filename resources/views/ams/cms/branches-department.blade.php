        ...
        <div class="rounded-md border-2 border-gray-100 bg-white shadow-lg">
            <div class="flex flex-col lg:flex-row border-b border-gray-200 relative">
                ...
                <div class="relative group w-full lg:w-32 p-4 text-center border-b-2 lg:border-b-2 border-blue-900 cursor-pointer">
                    <a href="/ams/cms/branch-department" class="flex flex-row items-center justify-center gap-x-2 font-semibold text-blue-900">
                        CMS
        ...
        <div class="rounded-md border-2 border-gray-100 bg-white shadow-lg -mt-4">
            <div class="flex flex-col justify-between">
                ...
                <div class="flex flex-wrap items-center gap-x-1 text-blue-900 text-sm px-7 pt-5">
                    ...
                    <a x-show="selected === 'branch'" x-transition href="/ams/cms/branch-department" class="hover:underline font-semibold">Branch</a>
                    <a x-show="selected === 'department'" x-transition href="/ams/cms/branch-department" class="hover:underline font-semibold">Department</a>
                </div>
                {{-- Top-right: Toggle + Add Buttons --}}
                <div class="flex justify-end px-7 pt-2 pb-2">
