        ...
        <div class="-mt-4 bg-white border-2 border-gray-100 rounded-md shadow-lg">
            <div class="flex flex-col justify-between">
                ...
                <div class="flex flex-wrap items-center px-2 pt-3 text-sm text-blue-900 gap-x-1 lg:p-5">
                    ...
                    <a href="/ams/all-assets" class="font-semibold hover:underline">Available Assets</a>
                </div>

                <div
                    class="flex flex-col items-start justify-between gap-4 px-5 py-6 -mt-6 sm:flex-row sm:items-center">

                    <!-- Title and Subtitle -->
                    <div>
                        <h2 class="text-lg font-semibold text-blue-900">Available Assets</h2>
                        <p class="text-sm text-gray-900">Borrow, Transfer and View Asset History</p>
                    </div>
                    ...
                    <div x-data="{ open: false }" class="relative w-full sm:w-[280px]">
                        ...
                        <div x-show="open" @click.away="open = false"
                            class="absolute right-0 z-50 mt-2 text-sm bg-white border border-gray-200 rounded-md shadow-lg w-60">
                            <div class="p-3 space-y-2 text-gray-700">
                                <div>
                                    <label class="block mb-1 text-xs font-medium text-gray-500">CATEGORY</label>
                                    <select
                                        class="w-full text-xs uppercase border-gray-300 rounded-md shadow-sm focus:ring-blue-600 focus:border-blue-600">
