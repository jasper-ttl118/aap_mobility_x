<x-app-layout class='flex flex-row w-h-screen'
    ...
    init() {
        ...
        : 'bg-gradient-to-br from-blue-100 to-blue-50 border border-blue-200'"
                        class="grid grid-cols-4 items-start w-full gap-5 p-5 rounded-xl  shadow-sm transition-colors duration-300 -mt-6 mb-4">
                        ...
                        <div class="col-span-1 flex items-start gap-3">
                            ...
                            <div class="flex flex-col items-start text-left w-full">
                                ...
                                <template x-if="!editMode">
                                    <div class="text-xl font-semibold uppercase text-blue-800 break-words max-w-full">
                                ...
                                <template x-if="editMode">
                                    <div class="flex flex-wrap items-center gap-2 w-full">
                                        <div
                                            class="text-xl font-semibold uppercase text-blue-800 break-words max-w-full">
                                            {{ $asset->asset_name ?? 'NO DATA' }}
                                        </div>
                                        <svg @click="openSectionEditor('name')" xmlns="http://www.w3.org/2000/svg"
                                            fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                            class="size-4 text-gray-600 hover:scale-110 hover:text-blue-600 animate-pulseScale">
                        ...
                        <!-- Column 3: Brand -->
                        <div class="flex flex-col items-start w-full relative group">
                            <span class="text-xs font-semibold text-gray-600 mb-1">Brand</span>

                            <!-- View Mode -->
                            <template x-if="!editMode">
                                <div class="text-xl font-semibold uppercase text-blue-800 text-left">
                            ...
                            <!-- Edit Mode (Left-Aligned Name + Icon) -->
                            <template x-if="editMode">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-8 overflow-visible">
                        ...
                        <div @click="if (editMode) openSectionEditor('info')"
                            ...
                            <div class="flex justify-between items-center mb-3">
                                ...
                                <div class="flex items-center gap-x-2 text-blue-700">
                                    ...
                                    <h3 class="text-sm font-bold text-blue-700 uppercase">Asset Information</h3>
                                </div>

                                <!-- Click to Edit -->
                                <template x-if="editMode">
                                    <div class="text-xs font-medium text-gray-500 italic cursor-pointer transition">
                                        Click Card to Edit
                                    </div>
                                </template>
                        ...
                        <div @click="editMode && openSectionEditor('assignment')"
                            ...
                            <div class="grid grid-cols-1 gap-1 text-sm">
                                <div class="flex justify-between">
                                    <span class="font-bold text-gray-600">Asset Type:</span>
                                ...
                                <div class="flex justify-between">
                                    <span class="font-bold text-gray-600">Date Assigned:</span>
                                    <span class="text-gray-800">
                                        {{ optional($asset->date_accountable)->format('F d, Y') ?? 'NO DATA' }}
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div @click="editMode && openSectionEditor('warranty')"
                            ...
                            <div class="grid grid-cols-1 gap-1 text-sm">
                                <!-- Purchase Date -->
                                <div class="flex justify-between">
                                    <span class="font-bold text-gray-600">Purchase Date:</span>
                                    <span class="text-gray-800">
                                        {{ optional($asset->purchase_date)->format('F d, Y') ?? 'NO DATA' }}
                                    </span>
                                </div>

                                <!-- Free Replacement Period -->
                                <div class="flex justify-between">
                                    <span class="font-bold text-gray-600">Free Replacement Period:</span>
                                    <span class="text-gray-800">
                                        {{ optional($asset->free_replacement_period)->format('F d, Y') ?? 'NO DATA' }}
                                    </span>
                                </div>

                                <!-- Warranty Expiration Date -->
                                <div class="flex justify-between">
                                    <span class="font-bold text-gray-600">Warranty Expiration Date:</span>
                                    <span class="text-gray-800">
                                        {{ optional($asset->warranty_exp_date)->format('F d, Y') ?? 'NO DATA' }}
                                    </span>
                                </div>
                            </div>
                        </div>
