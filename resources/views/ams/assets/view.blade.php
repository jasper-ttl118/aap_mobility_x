<x-app-layout class='flex flex-row w-h-screen'
    ...
    <div class="flex flex-1 flex-col lg:ml-52 overflow-y-auto py-10 px-5 lg:p-10 gap-7 mt-12 bg-[#f3f4f6]">
        <!-- Options Container -->
        <div class="bg-white rounded-md shadow-lg -mt-7 ">
        ...
        <div class="@container/main rounded-md  bg-white justify-center items-center flex w-full flex-col shadow-lg">
            <main x-data="{
                ...
                {{-- CONTENT --}}
                <div x-data="{ showQR: false }" class="w-full max-w-6xl px-6 pb-6 mx-auto space-y-5 bg-transparent">
                    ...
                    <div
                        ...
                        <div class="flex items-start col-span-1 ">
                            ...
                            <div class="flex mr-5 rounded-full p-2 text-[4B5563] bg-[F0EDEB] self-center">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" class="size-10 lucide lucide-building-icon lucide-building">
                            ...
                            <div class="flex flex-col self-center w-full -space-y-1 text-left">
                                <!-- Brand + Model on single line -->
                                <div
                                    class="flex items-center gap-2 overflow-hidden text-xl font-semibold text-black uppercase whitespace-nowrap">
                                    ...
                                    <svg @click="openSectionEditor('name')" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        class="self-center text-gray-600 size-5 hover:scale-110 hover:text-blue-600">
                                ...
                                <div class="flex items-center gap-2">
                                    <div class="w-full text-lg font-medium text-gray-600 uppercase truncate">
                        ...
                        <div x-data="{ showQR: false }"
                            ...
                            <div
                                class="absolute z-10 hidden px-2 py-1 mb-2 text-xs text-white -translate-x-1/2 bg-black rounded -top-8 left-1/2 group-hover:flex whitespace-nowrap">
                                Show QR Code
                            </div>
                    ...
                    <div class="grid grid-cols-1 overflow-visible md:grid-cols-2 gap-y-4 gap-x-8">
                        ...
                        <div
                            ...
                            <div class="flex justify-between items-center mb-3 text-[540d6e]">
                                <!-- Icon + Title -->
                                <div class="flex items-center text-blue-700 gap-x-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                        class="size-4">
                                        <path fill-rule="evenodd"
                                ...
                                <!-- Click to Edit -->
                                <svg @click="openSectionEditor('info')" xmlns="http://www.w3.org/2000/svg" fill="none"
                                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                    class="self-center text-gray-600 size-5 hover:scale-110 hover:text-blue-600">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10" />
                        ...
                        <div
                            ...
                            <div class="flex items-center justify-between mb-3">
                                <!-- Left: Icon + Heading -->
                                <div class="flex items-center text-red-600 gap-x-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                        class="size-4">
                                        <path fill-rule="evenodd"
                        ...
                        <div
                            ...
                            <div class="flex items-center justify-between mb-3">
                                <!-- Left: Icon + Label -->
                                <div class="flex items-center text-yellow-500 gap-x-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                        class="size-4">
                                        <path fill-rule="evenodd"
                            ...
                            <p class="text-sm text-justify text-gray-800">{{ $asset->description }}</p>
                        </div>
                    ...
                    <div class="flex justify-end mt-6 gap-x-3">
                        ...
                        <a href="/ams/all-assets"
                            class="inline-flex items-center gap-2 px-4 py-2 text-sm text-white transition bg-blue-900 rounded-md hover:bg-blue-700">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                class="w-5 h-5">
                                <path fill-rule="evenodd"
