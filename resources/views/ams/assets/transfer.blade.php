<x-app-layout class='flex flex-row w-h-screen'
    ...
    <div class="flex flex-1 flex-col lg:ml-52 overflow-y-auto py-10 px-5  gap-7 mt-12 bg-[#f3f4f6]">
        <!-- Options Container -->
        <div class="w-full bg-white rounded-md shadow-lg -mt-7 ">
        ...
        <div class="flex flex-col w-full -mt-2 bg-white rounded-lg shadow-lg">
            <div class="flex w-full mt-3 ">
                    ...
                    <div class="flex flex-wrap items-center px-2 pt-3 text-sm text-blue-900 gap-x-1 lg:p-5">
                        ...
                        <a href="/ams/common-assets" class="hover:underline">Available Assets</a>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-4 h-4">
                            <path fill-rule="evenodd"
                                d="M16.28 11.47a.75.75 0 0 1 0 1.06l-7.5 7.5a.75.75 0 0 1-1.06-1.06L14.69 12 7.72 5.03a.75.75 0 0 1 1.06-1.06l7.5 7.5Z"
                                clip-rule="evenodd" />
                        </svg>
                        <a href="#" class="font-semibold hover:underline">Transfer Asset</a>
                    </div>
                </div>
