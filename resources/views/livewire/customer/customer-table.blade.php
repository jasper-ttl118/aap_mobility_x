    ...
    <tbody>
        @foreach ($customers as $customer)
            <tr class="border-b border-gray-200 bg-white">
                ...
                <td class="w-[12.5%] py-4  text-gray-900">{{ $customer->customer_firstname }}
                    {{ $customer->customer_surname }}</td>
                <td class="w-[12.5%] py-4  text-gray-900">{{ $customer->customer_email }}</td>
                <td class="w-[12.5%] py-4  text-gray-900">{{ $customer->customer_mobile_number }}</td>
                <td class="w-[12.5%] py-4  text-gray-900">{{ $customer->customer_organization }}</td>
