                ...
                <div class="text-gray-700 p-4 space-y-4">
                    ...
                    <div class="flex justify-between mt-0 gap-x-2 border-4 border-gray-100 bg-gray-100 rounded-md {{ ($selected_tab === 'list') ? 'p-0' : 'py-3'}}">
                        <div class="flex justify-start items-center">
                            ...
                            <a wire:click="showBirthdayMessage"
                                class="flex items-center gap-1 text-[#5556AB] text-sm font-semibold ml-1 mr-1 {{ ($selected_tab === 'message') ? 'text-gray-500 pointer-events-none' : 'text-[#5556AB] cursor-pointer'}}">
                                    | Customize Message
                             </a>
