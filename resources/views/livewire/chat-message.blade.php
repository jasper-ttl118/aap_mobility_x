...
{{-- 
    ...
    <div class="flex flex-row card-actions justify-end items-center w-full border-t-2 border-[#605E5E] py-2">
      ...
      <input type="text" class="input input-bordered w-full mr-2 rounded-2xl text-sm" placeholder="Type a message"  wire:model="messages"/>
      <a wire:click="sendMessage">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-10 mr-2">
