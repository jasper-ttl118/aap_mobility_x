<div>
    ...
    @if ($viewOpen)
        <div wire:loading.remove x-cloak x-show="open_view_employee" id="viewEmployeeModal" class="fixed inset-0 flex items-center justify-center z-50 bg-gray-900 bg-opacity-50" >
            <!-- View Employee Modal -->
            <div class="overflow-x-auto hide-scrollbar bg-white rounded-lg shadow-lg h-[90%] lg:h-[93%] w-[90%] lg:w-full max-w-lg p-6" @click.stop @click.away="open_view_employee=false">
                <!-- Modal Header -->
                <div class="flex justify-between items-center border-b pb-3">
                    ...
                    <div class="flex justify-end gap-2 border-t pt-3">       
                        <button class="px-4 py-2 bg-gray-200 rounded-lg hover:bg-gray-300 text-[#151847]" @click="open_view_employee=false">
                            Close
                        </button>
                    </div>
                </div>
