                    ...
                    <tr class="border-b border-gray-200 bg-white">
                        ...
                        {{-- {{$employee->employee_id}} --}}
                                ...
                                <a href="{{ route('editEmployee') }}"
                                    ...
                                    <div class="absolute bottom-full mb-2 -left-0 -translate-x-1/2 bg-black text-white text-xs rounded py-1 px-2 whitespace-nowrap opacity-0 group-hover:opacity-100 transition z-10">
                                        Edit Profile
                                    </div>
                                </a>
                                ...
                                <a href="javascript:void(0)"
                                    ...
                                    <div class="absolute bottom-full mb-2 -left-8 -translate-x-1/2 bg-black text-white text-xs rounded py-1 px-2 whitespace-nowrap opacity-0 group-hover:opacity-100 transition z-10">
                                        Delete Profile
                                    </div>
                                </a>
                            </div>
