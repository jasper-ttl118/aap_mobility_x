                    ...
                    <tr class="border-b border-gray-200 bg-white">
                        ...
                        {{-- {{$employee->employee_id}} --}}
                                ...
                                >
                                    ...
                                    <div class="absolute bottom-full mb-2 left-1/2 -translate-x-1/2 bg-black text-white text-xs rounded py-1 px-2 whitespace-nowrap opacity-0 group-hover:opacity-100 transition z-10 pointer-events-none">
                                        View Profile
                                    </div>
                                </a>
                                ...
                                <a href="{{ route('editEmployee') }}"
                                    ...
                                    " --}}
                                    class="cursor-pointer group relative gap-1 font-medium text-blue-800">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                        fill="currentColor" class="size-4">
                                        <path
                                    ...
                                    <div class="absolute bottom-full mb-2 -left-0 -translate-x-1/2 bg-black text-white text-xs rounded py-1 px-2 whitespace-nowrap opacity-0 group-hover:opacity-100 transition z-10 pointer-events-none">
                                        Edit Profile
                                    </div>
                                </a>
                                ...
                                <a href="javascript:void(0)"
                                    ...
                                    class="cursor-pointer relative group gap-1 font-medium text-red-700">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                        fill="currentColor" class="size-4">
                                        <path fill-rule="evenodd"
                                    ...
                                    <div class="absolute bottom-full mb-2 -left-8 -translate-x-1/2 bg-black text-white text-xs rounded py-1 px-2 whitespace-nowrap opacity-0 group-hover:opacity-100 transition z-10 pointer-events-none">
                                        Delete Profile
                                    </div>
                                </a>
                            </div>
