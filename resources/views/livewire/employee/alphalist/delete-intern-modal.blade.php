<div @close-modal.window="open_delete_intern=false" class="bg-white rounded-lg shadow-lg w-96 p-6 dark:bg-gray-800" @click.away="open_delete_intern = false">
    <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Confirm Deletion</h2>
    <p class="mt-2 text-sm text-gray-600 dark:text-gray-300">
        Are you sure you want to delete this OJT intern? This action cannot be undone.
    </p>

    <div class="mt-4 flex justify-end items-center space-x-3">
        <form id="delete-form" wire:submit="delete" method="POST" class="inline-block m-0 p-0">
            @csrf
            @method('GET')
            <button type="submit"
        ...
        <button @click="open_delete_intern = false"
