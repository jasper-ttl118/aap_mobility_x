<div>
    ...
    @if ($requisition)
        <form wire:loading.remove wire:submit="edit" @close-modal.window="open_edit=false"
            ...
            <div class="text-gray-700 p-4 space-y-3">
                ...
                <div class="border-b border-gray-200 pb-3">
                    <h1 class="text-base font-semibold uppercase">Edit Vacant Job</h1>
                    <p class="text-xs text-gray-600">Edit vacnat job information.</p>
                </div>
