                    ...
                    <div class="flex flex-row justify-center items-center gap-2">
                            <a
                                ...
                                @click="open_view = true;       
                                    window.Livewire.dispatch('loadVacantJob', { requisition_id: {{ $approvedRequisition->requisition_id }} });
                                    "
                            ...
                            <a @click="open_edit = true; 
                                        window.Livewire.dispatch('loadEditVacantJob', { requisition_id: {{ $approvedRequisition->requisition_id }}})
                                "
                            ...
                            <a href="javascript:void(0)"
                                @click="open_delete = true; Livewire.dispatch('getVacantJobId', { requisition_id: {{ $approvedRequisition->requisition_id }} });"
