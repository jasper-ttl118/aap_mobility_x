<form wire:submit="add"
    ...
    <div class="text-gray-700 p-4 space-y-3">
        ...
        <div class="border-b border-gray-200 pb-3">
            <h1 class="text-base font-semibold uppercase">Requisition Ticket</h1>
        ...
        <div>
            ...
            <textarea name="job_description" placeholder="e.g. Proficient in Laravel"
                ...
                class="w-full bg-gray-100 rounded border border-gray-300 px-2 py-1 text-sm mt-1 focus:outline-blue-500"
                rows="3"></textarea>
