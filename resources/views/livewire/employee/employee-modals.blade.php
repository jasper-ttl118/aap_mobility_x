<div>
        ...
        <div x-show="viewOpen" x-transition class="fixed inset-0 flex items-center justify-center z-50">
            <div class="bg-white rounded-lg shadow-lg w-full max-w-2xl p-6">
                ...
                <div class="flex justify-end gap-2 border-t pt-3">
                    {{-- <button wire:click="$emit('toggleModal')">Close Modal</button> --}}
    ...
    @if ($viewOpen)
        <!-- View Employee Modal -->
        <div id="viewEmployeeModal" class="fixed inset-0 flex items-center justify-center z-50 bg-gray-900 bg-opacity-50" wire:click="close">
            <div class="bg-white rounded-lg shadow-lg w-full max-w-2xl p-6">
                <!-- Modal Header -->
                <div class="flex justify-between items-center border-b pb-3">
                    <h2 class="text-xl font-semibold">Employee Details</h2>
