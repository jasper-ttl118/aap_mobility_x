                    ...
                    <td class="py-3 pr-2">
                        <div class="flex justify-center items-center gap-3">
                            ...
                            <div class="relative group">
                                <a href="assets/borrow"
                                    class="text-green-700 hover:text-green-900 transition inline-flex items-center justify-center">
                            ...
                            <!-- Transfer Asset -->
                            <div class="relative group">
                                <a href="{{ url('assets/transfer/' . $asset->asset_id) }}"
                                    class="text-blue-700 hover:text-blue-900 transition inline-flex items-center justify-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                        class="size-4 hover:scale-110">
                                        <path fill-rule="evenodd"
                            ...
                            <div class="relative group">
                                <button @click="Livewire.dispatch('viewHistory', { code: '{{ $asset['code'] }}' })"
                                    class="text-amber-600 hover:text-amber-800 transition inline-flex items-center justify-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                        class="size-4 hover:scale-110">
                                        <path fill-rule="evenodd"
