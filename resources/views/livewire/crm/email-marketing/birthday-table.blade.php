<div x-data="{open : false}" class="lg:mx-7 mb-10 mr-15 justify-center overflow-x-auto hide-scrollbar -ml-2 lg:ml-7">
            ...
            @foreach ($customers as $customer)
                <tr wire:key="customer-{{ $customer->id }}" class="border-b border-gray-200 bg-white gap-5 font-inter">
                    ...
                    {{-- {{$customer->customer_id}} --}}
                            <a @click="open=true" class="cursor-pointer text-[#151847]">
