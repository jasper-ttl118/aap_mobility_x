<div x-data="{ show:false }"> 
    ...
    <!-- Modal content -->
        ...
        Happy shopping! 🛍️
                ...
                <div class="flex flex-col h-[30%] w-full lg:w-[30%] lg:h-full justify-evenly items-center gap-3">
                    ...
                    <div class="flex justify-end w-full gap-x-4">
                        <button wire:click="save" @click="toast=true, view_edit=false"  class="border-2 bg-[#071d49] p-2 rounded-lg text-white w-[50%] font-semibold">
                            Save
                        </button>
