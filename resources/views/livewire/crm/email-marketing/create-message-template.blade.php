...
<div class="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
  ...
  <div @click.outside="open=false" 
    ...
    <div class="flex justify-between rounded-t-lg p-3 items-center bg-[#494949]">
    ...
    <div class="flex flex-row w-full h-full justify-evenly px-4 gap-4">
        <div class="flex justify-center mt-2 items-center  w-[70%] h-[272px]">
            <!-- Left form section -->
            <form class=" w-full h-[252px] bg-[#EAE8E8] p-4 rounded-lg  flex flex-col justify-between">
                ...
                <textarea id="message" rows="4" class="resize-none h-[200px] block p-4 w-full text-sm text-gray-900 border-0 bg-gray-100 rounded-lg dark:bg-gray-300 dark:placeholder-gray-600" placeholder="Enter Your Message..."></textarea>
            </form>
        </div>
        <div class="flex flex-col w-[30%] h-full justify-evenly items-center gap-3 mt-2">
            <!-- Right variable section -->
            <div class="flex flex-col w-full h-[200px] p-4 gap-4 bg-[#EAE8E8] rounded-lg">
                <p class="font-semibold">Add Variable:</p>
