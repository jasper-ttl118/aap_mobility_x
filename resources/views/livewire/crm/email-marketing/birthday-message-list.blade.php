    ...
    <table class="w-full text-sm text-gray-500">
        ...
        <thead class="bg-gray-100 text-xs text-gray-700 uppercase">
            <tr>    
                ...
                <th scope="col" class="w-[19.0%] py-3">Title</th>
                {{-- <th scope="col" class="w-[17.0%] py-3">Content</th> --}}
                <th scope="col" class="w-[12.5%] py-3">Action</th>
            </tr>
        </thead>
        <tbody>
            @foreach ($messages as $message)
                <tr class="border-b border-gray-200 bg-white">
                    <td scope="row" class="w-[12.5%] py-4 font-medium whitespace-nowrap text-gray-900 text-center">
                        {{ $message->message_id }}</td>
                    <td class="w-[12.5%] py-4  text-gray-900 pl-16">{{ $message->message_title }}</td>
                    {{-- <td class="w-[12.5%] py-4  text-gray-900 text-center">{{ $message->message_content}}</td> --}}
