<div>
    ...
    @if ($reseller)
        ...
        <div @click.outside="
            ...
            wire:key="reseller-profile-{{ $reseller->customer_id }}"
            ...
            <div class="lg:w-[40%] w-full lg:h-full h-[50%] bg-white rounded-[36px] flex flex-col justify-center items-center ">
                ...
                <div class="w-full h-[70%] flex flex-col items-center justify-start -gap-1 lg:gap-1 pt-[60px] lg:pt-[75px]">
                    ...
                    <div class="text-xl lg:text-2xl font-bold text-[#151847] flex flex-row justify-center items-center w-full h-auto ">{{ $reseller->customer_firstname }} {{ $reseller->customer_middlename }} {{ $reseller->customer_surname}}</div>
            ...
            <div x-data="{profile: 'information'}" class="lg:w-[60%] w-full lg:h-full h-[50%] bg-white rounded-[36px] flex flex-col justify-start items-center p-5">
                {{-- Information --}}
                <div class="w-[110%] h-[10%] text-[#151847] font-bold text-xl lg:text-2xl flex items-center shadow-lg px-10 gap-3">
                ...
                <div class="w-full h-full mt-5">
                    <div x-show="profile === 'information'">
                        <div class="flex flex-col w-full h-[70%] lg:h-[40%]">
                            ...
                            <div class="flex flex-row items-center w-full h-[20%]">
                                ...
                                <div class="h-[60%] border border-[#605e5e] flex"></div>
                                <div class="w-[50%] text-xs lg:text-sm h-full flex justify-end items-center px-5 text-[#605e5e]">{{ $reseller->customer_email}}</div>
                            </div>
                            <div class="flex flex-row items-center w-full h-[20%]">
                                <div class="w-[50%] text-[#605e5e] h-full flex flex-row justify-start items-center px-5 gap-2 text-sm lg:text-base">
                                ...
                                <div class="h-[60%] border border-[#605e5e] flex"></div>
                                <div class="w-[50%] text-xs lg:text-sm h-full flex justify-end items-center px-5 text-[#605e5e]">{{ $reseller->customer_organization}}</div>
                            </div>
                            <div class="flex flex-row items-center w-full h-[20%]">
                                <div class="w-[50%] text-[#605e5e] h-full flex flex-row justify-start items-center px-5 gap-2 text-sm lg:text-base">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-4">
                                ...
                                <div class="h-[60%] border border-[#605e5e] flex"></div>
                                <div class="w-[50%] text-xs lg:text-sm h-full flex justify-end items-center px-5 text-[#605e5e]">{{ $reseller->customer_mobile_number}}</div>
                            </div>
                            <div class="flex flex-row items-center w-full h-[20%]">
                                <div class="w-[50%] text-[#605e5e] h-full flex flex-row justify-start items-center px-5 gap-2 text-sm lg:text-base">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-4">
                                ...
                                <div class="h-[60%] border border-[#605e5e] flex"></div>
                                <div class="w-[50%] text-xs lg:text-sm h-full flex justify-end items-center px-5 text-[#605e5e]">{{ $reseller->customer_birthdate}}</div>
                            </div>
                        </div>
                    ...
                    <div x-show="profile === 'activityLog'">
