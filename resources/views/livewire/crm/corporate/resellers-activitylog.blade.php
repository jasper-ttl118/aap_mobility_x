<div>
    ...
    <div class="bg-white w-full h-40 lg:h-[50%] relative min-h-0 overflow-hidden mt-0.5 border rounded-b-xl border-[#151847]">
        {{-- Table Header --}}
        ...
        {{-- Data --}}
        <div class="bg-white w-full h-[75%] lg:h-[85%] overflow-x-auto hide-scrollbar border rounded-b-xl border-[#151847]">
