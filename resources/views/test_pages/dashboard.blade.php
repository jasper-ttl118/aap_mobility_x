            ...
            <div class="h-auto w-96 rounded-lg bg-gray-50 shadow shadow-gray-400">
                <div class="h-22 w-96">
                    <img src="https://images.pexels.com/photos/161251/senso-ji-temple-japan-kyoto-landmark-161251.jpeg"
                        alt="" class="h-72 w-96 rounded-t-lg object-cover object-bottom" />
                </div>
                <div class="p-7">
            ...
            <div class="h-auto w-96 rounded-lg bg-gray-50 shadow shadow-gray-400">
                <div class="h-72 w-96">
                    <img src="https://images.pexels.com/photos/7039842/pexels-photo-7039842.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
                        alt="" class="h-72 w-96 rounded-t-lg object-cover object-center" />
                </div>
                <div class="p-7">
                    ...
                    <div class="my-8">
                        <a href="https://www.britannica.com/place/Manila"
                            class="rounded-md bg-green-600 p-2 font-medium text-white hover:bg-blue-950">Learn More</a>
                    </div>
                </div>
            </div>
        </div>
