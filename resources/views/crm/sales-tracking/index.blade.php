<x-app-layout class='flex flex-row w-h-screen' navbar_selected='CRM' :x_data="['open' => false, 'deleteUrl' => '', 'viewOpen' => false, 'employee' => new stdClass()]">
    <div class="flex flex-1 flex-col lg:ml-64 hide-scrollbar lg:p-10 lg:gap-7 bg-[#f3f4f6]">
        ...
        <div class="flex flex-col lg:flex-row h-[600px] lg:h-[300px] ml-5 lg:ml-0 w-[440px] lg:w-full border border-white lg:-mt-10 bg-[#f3f3f3] shadow-md rounded-md py-4 lg:py-0 px-4 gap-3 items-center justify-center ">
            ...
            <div class="h-[50%] lg:h-[90%] lg:w-[50%] w-full flex flex-row justify-center items-center gap-x-3 ">
                <div class="flex flex-col w-full lg:w-[50%] h-full lg:h-[90%] items-center justify-evenly gap-y-5">
                    {{-- First Box --}}
                    <div class="flex flex-row w-full h-full lg:h-[48%] bg-white shadow-md rounded-md items-center px-2 gap-3">
                        ...
                        <div class="flex flex-col w-full h-[70%] justify-center items-start py-2">
                            <div class="flex flex-row w-full gap-2">
                                <span class="text-[#151847] font-extrabold text-xs lg:text-md uppercase tracking-wide lg:tracking-wider">Total Sales</span>
                                <span class="text-green-400 font-bold text-xs lg:text-md  bg-green-400 bg-opacity-20  rounded-md"> +22%</span>
                            </div>
                    ...
                    <div class="flex flex-row w-full h-full lg:h-[48%] bg-white shadow-md rounded-md items-center px-2 gap-3">
                        ...
                        <div class="flex flex-col w-full h-[70%] justify-center items-start py-2">
                            <span class="text-[#151847] font-extrabold text-xs lg:text-md uppercase tracking-wider lg:tracking-wider">Average Deals Sized</span>                             
                ...
                <div class="flex flex-col w-full lg:w-[50%] h-full lg:h-[90%] items-center justify-evenly gap-y-5">
                    ...
                    <div class="flex flex-row w-full h-full lg:h-[48%] bg-white shadow-md rounded-md items-center px-2 gap-3">
                        ...
                        <div class="flex flex-col w-full h-[70%] justify-center items-start py-2">
                            <span class="text-[#151847] font-extrabold text-xs lg:text-md uppercase tracking-wider lg:tracking-wider">Deals Closed</span>                             
                            <span class="text-[#151847] font-bold text-lg lg:text-xl">109,073</span>
                        </div>
                    </div>
                    {{-- Fourth Box --}}
                    <div class="flex w-full h-full lg:h-[48%] bg-white shadow-md rounded-md items-center px-2 gap-3">
                        <div class="bg-[#dedede] rounded-2xl h-20 items-center justify-center flex p-1">
                        ...
                        <div class="flex flex-col w-full h-[70%] justify-center items-start py-2">
                            <span class="text-[#151847] font-extrabold text-xs lg:text-md uppercase tracking-wider lg:tracking-wider">Success Rate</span>                             
            ...
            {{-- Filter Sales --}}
            <div x-data="{activeFilter: 'filterToday'}" class="flex flex-col h-[60%] lg:h-[90%] w-full lg:w-[50%] items-center justify-center shadow-md rounded-md bg-white p-2">
                <div class="flex w-full h-[10%] items-center">
                    <div class="w-full h-full justify-center flex items-center flex-row px-4 gap-2">
                        ...
                        <span class="w-[65%] h-full justify-between flex text-[#151847] font-extrabold text-lg tracking-widest" > SALES</span>         
                            <div class="h-7  w-[35%] relative inline-block mt-2">
                                <button id="filter" class="flex justify-between items-center w-full h-full rounded-md border border-[#151847] shadow-sm px-2 py-2 uppercase bg-white text-xs font-bold text-[#151847] hover:text-white  hover:bg-[#151847]">
                                    Today
                                    <svg class="flex size-4" id="filterArrow" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                                    </svg>
                                </button>
        
                                <div id="filterContent"  class="hidden absolute z-10 h-50 w-full  rounded-md bg-white ">
                                    <div class="border-x shadow-xs rounded-b-md border-[#151847] bg-white w-full h-full border-b">
                                        <button @click="activeFilter = 'filterToday'" 
                                        ...
                                        <button @click="activeFilter = 'filterYesterday'" 
                                        ...
                                        <button @click="activeFilter = 'filterThisWeek'" 
                                        ...
                                        <button @click="activeFilter = 'filterLast7Days'" 
                                        ...
                                        <button @click="activeFilter = 'filterThisMonth'" 
                                        ...
                                        <button @click="activeFilter = 'filterLastMonth'" 
                                        ...
                                        <button @click="activeFilter = 'filterCustomRange'" 
                ...
                <div class="relative justify-center w-full h-[80%] mt-2">
                    <div x-show="activeFilter === 'filterToday'" x-cloak class="h-full w-full absolute">
                        <x-analytics-display
                            title="Today"
                    ...
                    <div x-show="activeFilter === 'filterYesterday'" x-cloak class="h-full w-full absolute">
                        <x-analytics-display
                            title="Yesterday"
                            :labels="['January', 'February', 'March', 'April', 'May']"
                            :data="[120, 150, 180, 90, 140]"
                    ...
                    <div x-show="activeFilter === 'filterThisWeek'" x-cloak class="h-full w-full absolute">
                        <x-analytics-display
                            title="This Week"
                            :labels="['January', 'February', 'March', 'April', 'May']"
                            :data="[120, 150, 180, 90, 140]"
                    ...
                    <div x-show="activeFilter === 'filterLast7Days'" x-cloak class="h-full w-full absolute">
                        <x-analytics-display
                            title="Last 7 Days"
                            :labels="['January', 'February', 'March', 'April', 'May']"
                            :data="[120, 150, 180, 90, 140]"
                    ...
                    <div x-show="activeFilter === 'filterThisMonth'" x-cloak class="h-full w-full absolute">
                        <x-analytics-display
                            title="This Month"
                            :labels="['January', 'February', 'March', 'April', 'May']"
                            :data="[120, 150, 180, 90, 140]"
                    ...
                    <div x-show="activeFilter === 'filterLastMonth'" x-cloak class="h-full w-full absolute">
                        <x-analytics-display
                            title="Last Month"
                            :labels="['January', 'February', 'March', 'April', 'May']"
                            :data="[120, 150, 180, 90, 140]"
                    ...
                    <div x-show="activeFilter === 'filterCustomRange'" x-cloak class="h-full w-full absolute">
                        <x-analytics-display
                            title="Custom Range"
                            :labels="['January', 'February', 'March', 'April', 'May']"
                            :data="[120, 150, 180, 90, 140]"
        ...
        <div class="flex flex-col lg:flex-row h-[600px] lg:h-[300px] ml-5 lg:ml-0 w-[440px] lg:w-full mt-3 lg:-mt-3 gap-3 items-center justify-center">
            ...
            <div class="flex flex-col w-full lg:w-[50%] h-[50%] lg:h-full bg-white shadow-md rounded-md">
                <div class="flex flex-col w-full h-full bg-white shadow-md rounded-md items-center justify-center">
                    <div class="flex flex-row w-[90%] h-[10%] justify-start items-center gap-2">
                        ...
                        <span class="text-md lg:text-lg text-[#151847] font-extrabold uppercase">Top Performing Sales Representatives</span>
                    </div>
                    <div class="flex flex-row w-[90%] h-[75%] justify-center items-centetext-md lg:r">
                        <x-analytics-display
                ...
                <div x-data="{activeChart: 'chart1'}" class="flex flex-col bg-white shadow-lg h-full w-full rounded-lg shadow-xs justify-center items-center gap-3">
                    <div class="flex flex-row h-[10%] w-[90%] items-center justify-between gap-2">
                        <div class="flex flex-row w-[50%] h-full justify-start items-center gap-2">
                            ...
                            <span class="text-[#151847] font-extrabold text-md lg:text-lg uppercase">Target vs. Actual</span>
                        </div>
                        <div class="flex justify-end w-[40%] lg:w-[50%] h-full items-center">
                            {{-- Buttons --}}
        ...
        <div class="flex flex-col lg:flex-row h-[900px] lg:h-[300px] ml-5 lg:ml-0 w-[440px] lg:w-full mt-3 lg:-mt-3 gap-3 items-center justify-center">
            {{-- Sales by Region --}}
            <div class="flex flex-col w-full lg:w-[33.3%] h-[33.3%] lg:h-full bg-white shadow-md rounded-md">
                <div class="flex flex-col w-full h-full bg-white shadow-md rounded-md items-center justify-center">
                    <div class="flex flex-row w-[90%] h-[10%] justify-start items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6 text-[#151847]">
                            <path fill-rule="evenodd" d="M15.22 6.268a.75.75 0 0 1 .968-.431l5.942 2.28a.75.75 0 0 1 .431.97l-2.28 5.94a.75.75 0 1 1-1.4-.537l1.63-4.251-1.086.484a11.2 11.2 0 0 0-5.45 5.173.75.75 0 0 1-1.199.19L9 12.312l-6.22 6.22a.75.75 0 0 1-1.06-1.061l6.75-6.75a.75.75 0 0 1 1.06 0l3.606 3.606a12.695 12.695 0 0 1 5.68-4.974l1.086-.483-4.251-1.632a.75.75 0 0 1-.432-.97Z" clip-rule="evenodd" />
                        </svg>
                        <span class="text-md lg:text-lg text-[#151847] font-extrabold uppercase">Sales by Region</span>
                    </div>
                    <div class="flex flex-row w-[90%] h-[75%] justify-center items-centetext-md lg:r">
                        <x-analytics-display
            ...
            <div class="flex flex-col w-full lg:w-[33.3%] h-[33.3%] lg:h-full bg-white shadow-md rounded-md">
                <div class="flex flex-col w-full h-full bg-white shadow-md rounded-md items-center justify-center">
                    <div class="flex flex-row w-[90%] h-[10%] justify-start items-center gap-2">
                        ...
                        <span class="text-md lg:text-lg text-[#151847] font-extrabold uppercase">Customers Segment</span>
                    </div>
                    <div class="flex flex-row w-[90%] h-[75%] justify-center items-centetext-md lg:r">
                        <x-analytics-display
            ...
            <div class="flex flex-col w-full lg:w-[33.3%] h-[33.3%] lg:h-full bg-white shadow-md rounded-md">
                <div class="flex flex-col w-full h-full bg-white shadow-md rounded-md items-center justify-center">
                    <div class="flex flex-row w-[90%] h-[10%] justify-start items-center gap-2">
                        ...
                        <span class="text-md lg:text-lg text-[#151847] font-extrabold uppercase">Sales by Stage</span>
                    </div>
                    <div class="flex flex-row w-[90%] h-[75%] justify-center items-centetext-md lg:r">
                        <x-analytics-display
        ...
        <div class="flex flex-col lg:flex-row h-[600px] lg:h-[300px] ml-5 lg:ml-0 w-[440px] lg:w-full mt-3 lg:-mt-3 gap-3 items-center justify-center">
            ...
            <div class="flex flex-col w-full lg:w-[40%] h-[50%] lg:h-full bg-white shadow-md rounded-md">
                <div class="flex flex-col w-full h-full bg-white shadow-md rounded-md items-center justify-center">
                    <div class="flex flex-row w-[90%] h-[10%] justify-start items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6 text-[#151847]">
                            <path fill-rule="evenodd" d="M15.22 6.268a.75.75 0 0 1 .968-.431l5.942 2.28a.75.75 0 0 1 .431.97l-2.28 5.94a.75.75 0 1 1-1.4-.537l1.63-4.251-1.086.484a11.2 11.2 0 0 0-5.45 5.173.75.75 0 0 1-1.199.19L9 12.312l-6.22 6.22a.75.75 0 0 1-1.06-1.061l6.75-6.75a.75.75 0 0 1 1.06 0l3.606 3.606a12.695 12.695 0 0 1 5.68-4.974l1.086-.483-4.251-1.632a.75.75 0 0 1-.432-.97Z" clip-rule="evenodd" />
                        </svg>
                        <span class="text-md lg:text-lg text-[#151847] font-extrabold uppercase">Deals Status Breakdown</span>
                    </div>
                    <div class="flex flex-row w-[90%] h-[75%] justify-center items-centetext-md lg:r">
                        <x-analytics-display
            ...
            <div class="flex flex-col w-full lg:w-[60%] h-[50%] lg:h-full bg-white shadow-md rounded-md">
                <div class="flex flex-col w-full h-full bg-white shadow-md rounded-md items-center justify-center">
                    <div class="flex flex-row w-[90%] h-[10%] justify-start items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6 text-[#151847]">
                            <path fill-rule="evenodd" d="M15.22 6.268a.75.75 0 0 1 .968-.431l5.942 2.28a.75.75 0 0 1 .431.97l-2.28 5.94a.75.75 0 1 1-1.4-.537l1.63-4.251-1.086.484a11.2 11.2 0 0 0-5.45 5.173.75.75 0 0 1-1.199.19L9 12.312l-6.22 6.22a.75.75 0 0 1-1.06-1.061l6.75-6.75a.75.75 0 0 1 1.06 0l3.606 3.606a12.695 12.695 0 0 1 5.68-4.974l1.086-.483-4.251-1.632a.75.75 0 0 1-.432-.97Z" clip-rule="evenodd" />
                        </svg>
                        <span class="text-md lg:text-lg text-[#151847] font-extrabold uppercase">Sales by Product/Service</span>
                    </div>
                    <div class="flex flex-row w-[90%] h-[75%] justify-center items-centetext-md lg:r">
                        <x-analytics-display
