                ...
                <div class="h-[50%] lg:h-[90%] lg:w-[50%] w-full flex flex-row justify-center items-center gap-x-3 ">
                    <div class="flex flex-col w-full lg:w-[50%] h-full lg:h-[90%] items-center justify-evenly gap-y-5">
                        ...
                        <div  onclick="my_modal_first.showModal()" class="cursor-pointer hover:scale-105 duration-300 transform flex flex-row w-full h-full lg:h-[48%] bg-white shadow-md rounded-md items-center px-2 gap-3">
                            ...
                            <dialog id="my_modal_first" class="modal rounded-xl border border-[#071d49] hide-scrollbar w-[60%] h-[50%]">
                        ...
                        <div onclick="my_modal_second.showModal()" class="cursor-pointer hover:-translate-y-2 hover:scale-105 duration-300 transform flex flex-row w-full h-full lg:h-[48%] bg-white shadow-md rounded-md items-center px-2 gap-3">
                           <div class="bg-[#dedede] rounded-2xl h-20 items-center justify-center flex p-1">
                            ...
                            <dialog id="my_modal_second" class="modal rounded-xl border border-[#071d49] hide-scrollbar w-[60%] h-[50%]">
                                <div class="modal-box flex flex-row p-3">
                                    <form method="dialog">
                                        <button class="btn btn-sm btn-circle btn-ghost absolute right-2 top-2">✕</button>
                                    </form>
                    ...
                    <div class="flex flex-col w-full lg:w-[50%] h-full lg:h-[90%] items-center justify-evenly gap-y-5">
                        ...
                        <div onclick="my_modal_third.showModal()" class="cursor-pointer hover:-translate-y-2 hover:scale-105 duration-300 transform flex flex-row w-full h-full lg:h-[48%] bg-white shadow-md rounded-md items-center px-2 gap-3">
                           <div class="bg-[#dedede] rounded-2xl h-20 items-center justify-center flex p-1">
                            ...
                            <dialog id="my_modal_third" class="modal rounded-xl border border-[#071d49] hide-scrollbar w-[60%] h-[50%]">
                                <div class="modal-box flex flex-row p-3">
                                    <form method="dialog">
                                        <button class="btn btn-sm btn-circle btn-ghost absolute right-2 top-2">✕</button>
                                    </form>
                        ...
                        <div onclick="my_modal_fourth.showModal()" class="cursor-pointer hover:-translate-y-2 hover:scale-105 duration-300 transform flex flex-row w-full h-full lg:h-[48%] bg-white shadow-md rounded-md items-center px-2 gap-3">
                           <div class="bg-[#dedede] rounded-2xl h-20 items-center justify-center flex p-1">
                            ...
                            <dialog id="my_modal_fourth" class="modal rounded-xl border border-[#071d49] hide-scrollbar w-[60%] h-[50%]">
                                <div class="modal-box flex flex-row p-3">
                                    <form method="dialog">
                                        <button class="btn btn-sm btn-circle btn-ghost absolute right-2 top-2">✕</button>
                                    </form>
                ...
                <div x-data="{activeFilter: 'Today'}" class="group hover:scale-105 duration-300 transform flex flex-col h-[60%] lg:h-[90%] w-full lg:w-[50%] items-center justify-center shadow-md rounded-md bg-white p-2">
                    <div class="flex w-full h-[10%] items-center">
                        <div class="w-full h-full justify-center flex items-center flex-row px-4 gap-2">
                            ...
                            <span class="w-[65%] h-full justify-between flex text-[#071d49] font-extrabold text-lg tracking-widest" >SALES</span>         
                            ...
                            <img src="{{ asset('full.png') }}" onclick="my_modal_Sales.showModal()" alt="full" class="size-5 hidden cursor-pointer group-hover:block flex justify-end duration-399 transform">
                                {{-- Full button --}}
                            <dialog id="my_modal_Sales" class="modal w-[60%] h-[70%] rounded-xl border border-[#071d49] hide-scrollbar">
                ...
                <div onclick="my_modal_SalesRep.showModal()" class="group cursor-pointer hover:scale-105  duration-300 transform flex flex-col w-full lg:w-[50%] h-[50%] lg:h-full bg-white shadow-md rounded-md">
                    <div class="flex flex-col w-full h-full bg-white shadow-md rounded-md items-center justify-center">
                        <div class="flex flex-row w-[90%] h-[10%] justify-start items-center">
                            ...
                            {{-- Full button --}}
                            <dialog id="my_modal_SalesRep" class="modal w-[70%] h-[70%] rounded-xl border border-[#071d49]">
                                <div class="modal-box p-5 w-full h-full ">
                                    <form method="dialog">
                                        <div class="flex flex-row gap-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6 text-[#071d49]">
                                            ...
                                            <span class="text-sm lg:text-2xl text-[#071d49] font-extrabold uppercase">Top Performing Sales Representatives</span>
                                        </div>
                                        <button class="btn btn-sm btn-circle btn-ghost absolute right-2 top-2">✕</button>
                                    </form>
                        ...
                        <div class="flex flex-row h-[10%] w-[90%] items-center justify-between gap-2">
                            <div class="flex flex-row w-full h-full justify-start items-center gap-2">
                                <div class="w-full h-full flex flex-row justify-start items-center gap-2">
                                    ...
                                    <span class="text-sm lg:text-lg text-[#071d49] font-extrabold uppercase group-hover:text-sm lg:group-hover:text-[17px]">Target vs. Actual</span>
                                </div>
                                ...
                                <dialog id="my_modal_TargetVsActual" class="modal w-[70%] h-[70%] rounded-xl  border border-[#071d49]">
                                    <div class="modal-box p-5 w-full h-full ">
                                        <form method="dialog">
                                            <div class="flex flex-row gap-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6 text-[#071d49]">
                    ...
                    <div class="flex flex-col w-full h-full bg-white shadow-md rounded-md items-center justify-center">
                        <div class="flex flex-row w-[90%] h-[10%] justify-start items-center gap-2">
                            <div class="w-full h-full flex flex-row justify-start items-center gap-2">
                                ...
                                <span class="text-sm lg:text-lg text-[#071d49] font-extrabold uppercase group-hover:text-sm lg:group-hover:text-lg">Sales by Region</span>
                            </div>
                            {{-- Full button --}}
                            <dialog id="my_modal_Region" class="modal w-[70%] h-[70%] rounded-xl border border-[#071d49]">
                                <div class="modal-box p-5 w-full h-full ">
                                    <form method="dialog">
                                        <div class="flex flex-row gap-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6 text-[#071d49]">
                    ...
                    <div class="flex flex-col w-full h-full bg-white shadow-md rounded-md items-center justify-center">
                        <div class="flex flex-row w-[90%] h-[10%] justify-start items-center gap-2">
                            <div class="w-full h-full flex flex-row justify-start items-center gap-2">
                                ...
                                <span class="text-sm lg:text-lg text-[#071d49] font-extrabold uppercase group-hover:text-sm lg:group-hover:text-lg">Customer Segment</span>
                            </div>
                            {{-- Full button --}}
                            <dialog id="my_modal_CustomerSegment" class="modal w-[70%] h-[70%] rounded-xl border border-[#071d49]">
                                <div class="modal-box p-5 w-full h-full ">
                                    <form method="dialog">
                                        <div class="flex flex-row gap-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6 text-[#071d49]">
                    ...
                    <div class="flex flex-col w-full h-full bg-white shadow-md rounded-md items-center justify-center">
                        <div class="flex flex-row w-[90%] h-[10%] justify-start items-center gap-2">
                            <div class="w-full h-full flex flex-row justify-start items-center gap-2">
                                ...
                                <span class="text-sm lg:text-lg text-[#071d49] font-extrabold uppercase group-hover:text-sm lg:group-hover:text-lg">Sales by Stage</span>
                            </div>
                            {{-- Full button --}}
                            <dialog id="my_modal_SalesStage" class="modal w-[70%] h-[70%] rounded-xl border border-[#071d49]">
                                <div class="modal-box p-5 w-full h-full ">
                                    <form method="dialog">
                                        <div class="flex flex-row gap-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6 text-[#071d49]">
                    ...
                    <div class="flex flex-col w-full h-full bg-white shadow-md rounded-md items-center justify-center">
                        <div class="flex flex-row w-[90%] h-[10%] justify-start items-center gap-2">
                            <div class="w-full h-full flex flex-row justify-start items-center gap-2">
                                ...
                                <span class="text-sm lg:text-lg text-[#071d49] font-extrabold uppercase group-hover:text-sm lg:group-hover:text-lg">Deals Status Breakdown</span>
                            </div>
                            {{-- Full button --}}
                            <dialog id="my_modal_DealStatus" class="modal w-[70%] h-[70%] rounded-xl border border-[#071d49]">
                                <div class="modal-box p-5 w-full h-full ">
                                    <form method="dialog">
                                        <div class="flex flex-row gap-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6 text-[#071d49]">
                    ...
                    <div class="flex flex-col w-full h-full bg-white shadow-md rounded-md items-center justify-center">
                        <div class="flex flex-row w-[90%] h-[10%] justify-start items-center gap-2">
                            <div class="w-full h-full flex flex-row justify-start items-center gap-2">
                                ...
                                <span class="text-sm lg:text-lg text-[#071d49] font-extrabold uppercase group-hover:text-sm lg:group-hover:text-lg">Sales by Product/Service</span>
                            </div>
                            {{-- Full button --}}
                            <dialog id="my_modal_ProductsService" class="modal w-[70%] h-[70%] rounded-xl border border-[#071d49]">
                                <div class="modal-box p-5 w-full h-full ">
                                    <form method="dialog">
                                        <div class="flex flex-row gap-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6 text-[#071d49]">
