    ...
    <div x-data="{ toast: false, open: false, view_edit: false }">
        ...
        <div class="flex flex-1 flex-col lg:ml-52 lg:p-10 lg:gap-7 hide-scrollbar bg-[#f3f4f6]"> 
            ...
            <div class="flex md:w-full md:justify-center md:-ml-2.5 l">
                <div class="flex flex-col w-[440px] md:w-full md:ml-5 lg:-mt-8 pt-4 lg:w-full lg:ml-4 lg:px-0 px-5 justify-center gap-y-4 md:items-center">
                    <div class="flex items-start justify-between md:w-[80%] px-1 w-[440px] lg:w-full">
                        <div class="flex items-start ml-1">
                            <h2 class="font-extrabold text-xl uppercase tracking-widest text-[#071d49] font-inter">List of Templates</h2>
                        </div>
