<x-app-layout  class='flex flex-row w-h-screen' navbar_selected='CRM' :x_data="['open' => false, 'deleteUrl' => '', 'viewOpen' => false, 'employee' => new stdClass()]">
    <div x-data="{ toast: false, open: false, view_edit: false }">
        ...
        <div class="flex flex-1 flex-col lg:ml-52 lg:p-10 lg:gap-7 hide-scrollbar bg-[#f3f4f6]"> 
            ...
            <!-- Breadcrumbs-->
            <div class="flex h-10 items-center gap-x-1 text-blue-900 text-sm px-12 lg:px-7 pt-5 lg:pt-0 pb-3 lg:-mb-8 w-full md:ml-20 lg:ml-0">
                ...
                <a href="{{ route('message-template') }}" class="hover:underline font-semibold text-[#071d49] font-inter truncate">Message Templates</a>
            </div>
                ...
                <div class=" flex flex-col w-full justify-center gap-y-4 items-center">
                    <div class="flex items-start justify-between px-1 w-[90%] lg:w-full">
                        <div class="flex items-start">
                            <h2 class="font-extrabold text-lg lg:text-xl uppercase tracking-widest text-[#071d49] font-inter">List of Templates</h2>
                        </div>

                        <button @click="open=true" class="flex items-center bg-[#071d49] rounded-lg py-1 text-white gap-x-2 px-3 justify-center hover:bg-white hover:text-[#071d49] hover:border hover:scale-105 duration-300 transform border-[#071d49]">
                    ...
                    <div class="gap-y-10 w-[90%] lg:w-full flex justify-center items-center ">
                        <div class="carousel carousel-center flex bg-[#abcae9] w-full rounded-box space-x-4 p-2 border-2 border-[#071d49]">
                            <div class="carousel-item">
                                <div class="flex flex-col border-2 rounded-lg bg-[#071d49] h-[320px] lg:h-[270px] w-[210px] lg:w-[235px] flex-none p-5 gap-y-4">
                                    ...
                                    <button class="hover:bg-[#F6D400] hover:text-[#071d49] hover:border border-white hover:scale-105 duration-300 transform bg-white p-2 rounded-lg font-semibold text-[#071d49]" @click="view_edit=true">View Template -></button>
                                </div>
                            </div>
                            <div class="carousel-item">
                               <div class="flex flex-col border-2 rounded-lg bg-[#071d49] h-[320px] lg:h-[270px] w-[210px] lg:w-[235px] flex-none p-5 gap-y-4">
