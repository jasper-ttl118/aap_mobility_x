  ...
  <div x-data="{ open_mobile: false, view_edit: false }">
        ...
        <div class="flex flex-1 flex-col lg:ml-52 lg:p-10 lg:gap-7 hide-scrollbar bg-[#f3f4f6]"> 
            ...
            <div class="flex h-7 items-start gap-x-1 text-blue-900 text-sm px-12 lg:px-7 pt-2 lg:pt-0 lg:-mb-8 md:ml-20 lg:ml-0">
                ...
                <a href="{{ route('message-template') }}" class="hover:underline font-semibold text-[#151848] font-inter truncate">Compose Message</a>
            </div>
            ...
            <div class="flex md:w-full md:justify-center md:-ml-2.5">
                <div class="flex flex-col w-[440px]  lg:-mt-8 pt-4 lg:w-full lg:ml-0 lg:px-0 px-5 justify-center gap-y-4">
                    <div class="flex items-start justify-between px-1 w-[440px] lg:w-full">
                        ...
                        <button @click="open_mobile=true" class="flex items-center bg-[#151848] rounded-lg py-1 text-white gap-x-2 px-3 justify-center hover:bg-white hover:text-[#151847] hover:border hover:scale-105 duration-300 transform border-[#151847]">
