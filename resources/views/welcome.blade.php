...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-inter h-auto flex flex-col">
        <header class="fixed flex-row justify-between top-0 z-50 w-screen h-16 bg-white shadow-lg text-black items-start">
            <div class="flex items-center justify-between h-full">
        
                <a href="#" class="flex items-center">
                    <img src="{{ asset('aaplogo1.png') }}" alt="logo" class="ml-12 h-[65px] object-contain">
                </a>
            
                <button id="menu-toggle" class="sm:hidden mx-10 text-black focus:outline-none">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M4 6h16M4 12h16M4 18h16"/>
                    </svg>
                </button>
            
                <nav class="hidden sm:flex items-center justify-evenly gap-10">
            ...
            <div id="mobile-menu" class="sm:hidden hidden base:hidden lg:hidden xl:hidden flex flex-col bg-white px-4 py-4 space-y-3">
            <a href="#" class=" font-semibold hover:text-yellow-500 hover:translate-x-2 transition duration-300 ">Home</a>
            <a href="#" class="font-semibold hover:text-yellow-500 hover:translate-x-2 transition duration-300">About Us</a>
            <a href="#" class="font-semibold hover:text-yellow-500 hover:translate-x-2 transition duration-300">Contact Us</a>
            <form action="#">
                <button class="bg-yellow-500 text-black px-4 w-full py-2 font-semibold rounded-md hover:scale-105 transition">
        ...
        <footer class="flex flex-col items-center justify-center w-screen bg-[#071d49] h-[1000px] lg:h-[500px] border-t-4 border-t-yellow-500">
            <div class="flex flex-col justify-center items-center  lg:justify-evenly lg:w-full lg:flex-row lg:items-start pt-5 gap-5">
                ...
                <div class="flex flex-row">
                    <a href="https://facebook.com/yourpage" target="_blank" class="text-blue-600 hover:text-yellow-500">
                        <svg xmlns="http://www.w3.org/2000/svg" class="hover:text-yellow-500 hover:scale-125 transition-transform duration-300 h-8 w-8 mr-5 fill-current text-gray-500" viewBox="0 0 24 24">
                    ...
                    <a href="https://instagram.com/yourpage" target="_blank" class="text-pink-600 hover:text-yellow-500">
                        <svg xmlns="http://www.w3.org/2000/svg" class="hover:text-yellow-500 hover:scale-125 transition-transform duration-300 h-8 w-8 text-gray-500 fill-current" viewBox="0 0 24 24">
                ...
                <div class="flex flex-col items-center justify-start text-xl bg-[#071d49] h-[350px] min-w-[250px] max-w-[400px] rounded-md">
                    ...
                    <p class="mb-10 text-base text-gray-400 text-center">A member-exclusive benefit offering <br>a secure and transparent platform for purchasing Autocare-certified pre-<br>owned vehicles at a special rate.</p>
                    <p class="text-white italic text-sm">Powered by</p>
                    <div class="h-[50px]">
                        <img src="{{ asset('aaplogo1.png') }}" alt="logo" class="h-36 w-[150px]">            
                    </div>
                </div>
            </div>
            ...
            <div class="relative flex-row items-center justify-end">
                ...
                <p class="mb-2 text-gray-400 text-center text-sm sm:text-base">&copy; 2025 AAP Pre-Owned Prestige. All rights reserved.</p>
            </div>
        </footer>
    <script>
