                    ...
                    <div class="text-gray-700">
                        <form form action="/user" method="post" class="w-full">
                            @csrf
                                ...
                                <div class="">
                                    ...
                                    <div class="flex gap-2 mt-1">
                                        ...
                                        <input disabled type="text" value="{{ $employee->employee_middlename }}"
                                            name="employee_middlename" placeholder="Middle Name"
                                            class="w-full bg-gray-100 h-10 rounded border border-gray-300 px-3 focus:outline-blue-500">
                                        <input disabled type="text" value="{{ $employee->employee_lastname }}"
                                            name="employee_lastname" placeholder="Last Name"
                                            class="w-full bg-gray-100 h-10 rounded border border-gray-300 px-3 focus:outline-blue-500">
                                    </div>
                                </div>
                                ...
                                <Button type="submit"
                                    class="mt-10 bg-blue-800 text-white px-3 py-2 rounded-lg hover:bg-blue-900">Add
                                    User</Button>
                            </div>
                        </form>
