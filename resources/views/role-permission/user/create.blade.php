            ...
            <form form action="/user" method="post">
                ...
                <div class="text-gray-700 m-20">
                    <div class="flex flex-col pb-5 mb-5 border-b-2 border-gray-200">
                        <h1 class="text-lg font-bold uppercase">Add User</h1>
                        <p class="text-sm">Register a new user by creating a unique account within the system.</p>
                    </div>
                    <div class="flex flex-col gap-7">
                        <div class="flex flex-row gap-3">
                            <div class="flex flex-col gap-2 w-96">
                                <label for="" class="font-medium">Name</label>
                                <input type="text" name="name" placeholder="Enter Your Name"class="bg-gray-100 h-10 rounded-lg border-1 border-gray-200 px-3 focus:outline-blue-900 ">
                            </div>
                            <div class="flex flex-col gap-2 w-96">
                                <label for="" class="font-medium">Email</label>
                                <input type="email"  name="email" placeholder="sample@email.come"class="bg-gray-100 h-10 rounded-lg border-1 border-gray-200 px-3 focus:outline-blue-900 ">
                            </div>
                        </div>
                        <div class="flex flex-col gap-2 w-96">
