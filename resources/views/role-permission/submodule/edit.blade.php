...
{{-- <body class="flex flex-row h-screen">
    ...
    <div class="flex flex-col w-full ml-64 overflow-y-auto p-10 h-screen justify-center items-center">
        ...
        @endif
        <form action="{{ url('submodule/'.$submodule->submodule_id) }}" method="post" enctype="multipart/form-data" class="mx-auto max-w-md bg-white shadow-md rounded-lg overflow-hidden border border-gray-200">
            @csrf
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="border-b border-gray-200 pb-5">
                    <h1 class="text-xl font-semibold text-gray-800">Update Sub-Module</h1>
                    <p class="text-sm text-gray-500">
                        Update sub-module and re-assign it with available modules.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="submodule_name" value="{{ $submodule->submodule_name }}" placeholder="Module Name"
                ...
                <div>
                    ...
                    <input type="text" name="submodule_description" value="{{ $submodule->submodule_description }}" placeholder="Description"
                        class="w-full bg-gray-50 border border-gray-300 rounded-md px-4 py-2 mt-1 text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                </div>
        

                <div>
                    <select name="module_id" class="bg-gray-100 w-full mt-1 h-10 rounded-lg border-1 border-gray-200 px-3 focus:outline-blue-900">
                ...
                <div class="grid grid-cols-2 gap-2">
                    ...
                    <select name="submodule_status" class="w-full bg-gray-100 h-10 rounded border border-gray-300 px-3 mt-1 focus:outline-blue-500">
                        <option value='1' @selected(intval(old('submodule_status', $submodule->submodule_status)) === 1)>Active</option>
                        <option value='0' @selected(intval(old('submodule_status', $submodule->submodule_status)) === 0)>Inactive</option>
                    </select>
                    </div>
                </div>
...
<body class="flex flex-row min-h-screen">
    ...
    <div class="flex flex-1 flex-col ml-64 overflow-y-auto p-10 gap-7">
        ...
        <div class=" rounded-md border-2 border-gray-100 bg-gray-50">
            ...
            <form action="{{ url('submodule/' . $submodule->submodule_id) }}" method="post"
                    ...
                    <div class="col-span-6">
                        <div class="flex flex-col gap-4">
                            <div class="grid grid-cols-2 gap-4">
                                <div class="flex flex-col justify-center gap-2">
                                    <label for="submodule_name" class="text-sm font-medium text-blue-900">Submodule
                                        Name</label>
                                    <input type="text" value="{{ $submodule->submodule_name }}"
                                        name="submodule_name" placeholder=""
                            ...
                            <div class="flex flex-col justify-center gap-2">
                                ...
                                <input type="text" value="{{ $submodule->submodule_description }}"
                                    name="submodule_description" placeholder=""
                                    class="w-full bg-gray-100 h-10 rounded border border-gray-300 px-3 text-sm focus:outline-blue-500">
                            </div>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-10 items-center gap-10">
                    <div class="col-span-4">
                        ...
                        <p class="text-sm italic text-gray-600">
                            Set the module as active or inactive.
                        </p>
                    </div>
                    <div class="col-span-6">
                        <div class="">
                            <div class="flex flex-col justify-center gap-2">
                                <label for="submodule_status" class="text-sm font-medium text-blue-900">Status</label>
                                <div class="flex items-center gap-1">
                                    <label class="inline-flex items-center cursor-pointer">
                                        <!-- Hidden input to send '0' if checkbox is unchecked -->
                                        <input type="hidden" name="submodule_status" value="0">
                                        <input type="checkbox" name="submodule_status" id="submodule_status"
                                            class="sr-only peer toggle-checkbox"
                                            {{ old('submodule_status', $submodule->submodule_status) == 1 ? 'checked' : '' }}
                                            value="1">
                                        <div
                                    ...
                                    <span
                                        ...
                                        {{ old('submodule_status', $submodule->submodule_status) == 1 ? 'Active' : 'Inactive' }}
                                    </span>
                                </div>
                ...
                <div class="grid grid-cols-10 items-center pt-8 gap-10">
                    ...
                    <div class="col-span-6">
                        <div class="grid grid-cols-2 justify-between gap-2">
                            <div class="flex flex-col justify-center gap-2">
                                <Button type="submit"
                                    class="w-48 px-4 py-2 bg-blue-900 text-white rounded-lg hover:bg-blue-800">Update</Button>
                            </div>
                        </div>
                    </div>
                </div>
