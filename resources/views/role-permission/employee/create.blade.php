...
<body class="flex flex-row justify-center items-center h-screen">
    ...
    <div class="flex flex-col w-full h-auto">
        ...
        @endif
        <form action="/employee" method="post" class="max-w-lg mx-auto bg-white shadow-md rounded-lg overflow-hidden border border-gray-200">
            @csrf
            <div class="text-gray-700 p-6 space-y-6">
                ...
                <div class="border-b border-gray-200 pb-5">
                    ...
                    <p class="text-sm text-gray-600">
                        Register a new employee's personal details, including contact information, position, and department.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <div class="flex gap-2 mt-1">
                        <input type="text" name="employee_firstname" placeholder="First Name" class="w-full bg-gray-100 h-10 rounded border border-gray-300 px-3 focus:outline-blue-500">
                        <input type="text" name="employee_middlename" placeholder="Middle Name" class="w-full bg-gray-100 h-10 rounded border border-gray-300 px-3 focus:outline-blue-500">
                        <input type="text" name="employee_lastname" placeholder="Last Name" class="w-full bg-gray-100 h-10 rounded border border-gray-300 px-3 focus:outline-blue-500">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="employee_contact_number" placeholder="Enter Contact Number" class="w-full bg-gray-100 h-10 rounded border border-gray-300 px-3 mt-1 focus:outline-blue-500">
                </div>
        
                <!-- Email -->
                <div>
                    <label for="employee_email" class="font-medium">Email</label>
                    <input type="email" name="employee_email" placeholder="sample@email.com" class="w-full bg-gray-100 h-10 rounded border border-gray-300 px-3 mt-1 focus:outline-blue-500">
                </div>
        
                <!-- Address -->
                <div>
                    <label for="employee_address" class="font-medium">Address</label>
                    <input type="text" name="employee_address" placeholder="Enter Address" class="w-full bg-gray-100 h-10 rounded border border-gray-300 px-3 mt-1 focus:outline-blue-500">
                </div>
