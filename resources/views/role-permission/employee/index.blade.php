...
<body class="flex flex-row h-screen" x-data="{ open: false, deleteUrl: '', viewOpen: false, employee: {} }">
    ...
    <div class="flex flex-col w-full ml-64 overflow-y-auto p-10 h-screen justify-center items-center">
        ...
        <div class="w-full m-10 rounded-md border bg-white border-gray-100 p-5 shadow shadow-gray-300">
            <div class="flex justify-between items-center p-5">
                ...
                <a href="employee/create" class="flex uppercase rounded-lg items-center bg-blue-900 p-3 text-xs font-bold text-white hover:bg-indigo-800">
            ...
            <table class="w-full text-center text-sm text-gray-500">
                ...
                <tr class="border-b border-gray-200 bg-white">
                    <th scope="row" class="px-6 py-4 font-medium whitespace-nowrap text-gray-900">{{ $employee->employee_id }}</th>
                    <td class="px-auto py-4  text-gray-900">{{ $employee->employee_firstname }} {{ $employee->employee_lastname }}</td>
                    ...
                    <td class="px-auto py-4">
                        <div class="flex flex-row justify-center items-center gap-2">
                            <a @click="viewOpen = true; employee = {{ json_encode($employee) }}" class="flex items-center gap-1 font-medium text-gray-700 cursor-pointer">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-4">
                                    <path d="M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z" />
                                    <path fill-rule="evenodd" d="M1.323 11.447C2.811 6.976 7.028 3.75 12.001 3.75c4.97 0 9.185 3.223 10.675 7.69.12.362.12.752 0 1.113-1.487 4.471-5.705 7.697-10.677 7.697-4.97 0-9.186-3.223-10.675-7.69a1.762 1.762 0 0 1 0-1.113ZM17.25 12a5.25 5.25 0 1 1-10.5 0 5.25 5.25 0 0 1 10.5 0Z" clip-rule="evenodd" />
                                </svg> 
                            </a>
                            <a href="{{ url('employee/'.$employee->employee_id.'/edit') }}" class="flex items-center gap-1 font-medium text-blue-800">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-4">
                            ...
                            <a href="javascript:void(0)" @click="open = true; deleteUrl = '{{ url('employee/'.$employee->employee_id.'/delete') }}'" class="flex items-center gap-1 font-medium text-red-700">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-4">
    ...
    <div x-data="{ open: false }">
        ...
        <!-- Modal Content -->
        <div x-show="viewOpen" x-transition
            ...
            <div class="bg-white rounded-lg shadow-lg w-full max-w-2xl p-6">
                ...
                <div class="text-gray-700 p-4 space-y-4">
                    ...
                    <div>
                        ...
                        <p class="mt-1" x-text="employee.employee_firstname + ' ' + employee.employee_middlename + ' ' + employee.employee_lastname"></p>
                    </div>
                    ...
                    <div>
                        ...
                        <span class="inline-block px-3 py-1 rounded-full text-sm font-medium" :class="employee.employee_status == '1' ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'" x-text="employee.employee_status == '1' ? 'Active' : 'Inactive'"></span>
                    </div>
