        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ url('role/'.$role->id.'/edit-role-with-permissions') }}" method="post">
                            @csrf
                            @method('PUT')
            ...
            <form action="{{ url('role/'.$role->id.'/edit-role-with-permissions') }}" method="post">
                ...
                <div class="text-gray-700 m-20">
                    <div class="flex flex-col pb-5 mb-5 border-b-2 border-gray-200">
                        <h1 class="text-lg font-bold uppercase">Edit Role | 
                            <span class="text-gray-500">{{$role->name}}<span></h1>
                        <p class="text-sm">Update a Role with Assigned Privileges</p>
                    </div>
                    <div class="flex flex-col gap-7">
    
                        <div class="flex flex-col gap-2 w-96">
                            <label for="" class="font-medium">Role Name</label>
                            <input type="text" value="{{$role->name}}" name="name" placeholder="Enter Role Name"class="bg-gray-100 h-10 rounded-lg border-1 border-gray-200 px-3 focus:outline-blue-900 ">
                        </div>
