                                    ...
                                    <td class="w-1/12 py-4">
                                        <div class="flex justify-center items-center gap-2">
                                            ...
                                            <a href="{{ url('role/' . $role->role_id . '/edit') }}"
                                                class="flex items-center gap-1 font-medium text-blue-900 underline">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                    fill="currentColor" class="size-4">
                                                    <path
                        ...
                        <div class="bg-white rounded-lg shadow-lg w-full max-w-2xl p-6 max-h-[80vh] flex flex-col">
                            ...
                            <div class="text-gray-700 p-4 space-y-7 overflow-y-auto flex-1">
                                ...
                                <div x-show="role.prepared_modules && role.prepared_modules.length > 0">
                                    <label class="text-sm font-medium text-blue-900">Module Access and
                                        Permissions</label>
                                    <div class="overflow-x-auto">
                                        <table class="w-full mt-1 text-sm border-collapse border border-gray-300">
                                            <thead>
                                                <tr class="bg-gray-100">
                                                    <th class="border border-gray-300 px-6 py-3 font-medium">Modules
                                                    </th>
                                                    <th class="border border-gray-300 px-6 py-3 font-medium">
                                                        Sub-Modules</th>
                                                    <th class="border border-gray-300 px-6 py-3 font-medium">
                                                        Permissions</th>
                                                </tr>
