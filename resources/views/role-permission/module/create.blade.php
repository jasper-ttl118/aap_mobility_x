...
<body class="flex flex-row justify-center items-center h-screen">
    ...
    <div class="flex flex-col w-full h-auto">
        ...
        @endif
        <form action="/module" method="post" enctype="multipart/form-data" class="mx-auto max-w-md bg-white shadow-md rounded-lg overflow-hidden border border-gray-200">
            @csrf
