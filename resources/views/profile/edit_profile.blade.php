        ...
        <main class="space-y-6">
            <section class="space-y-1.5">
                ...
                <div class="p-5 bg-blue-100 rounded-xl space-y-8 @lg/main:space-y-14">
                    <div class="flex flex-col items-center justify-between gap-3 @lg/main:flex-row @lg/main:gap-[4.5rem]">
                    ...
                    <div class="flex flex-col items-center justify-between gap-3 @lg/main:flex-row @lg/main:gap-[4.5rem]">
                        ...
                        <div class="w-full max-w-4xl flex flex-col justify-between gap-6 @lg/main:w-[65%] @2xl/main:flex-row">
                    ...
                    <div class="flex flex-col items-center justify-between gap-3 @lg/main:flex-row @lg/main:gap-[4.5rem]">
                        <div class="w-full place-content-center @lg/main:w-[35%]">
                            ...
                            <p class="text-sm text-gray-600 leading-tight"><em>Enter an active address for important communications.</em></p>
                        </div>
                        <div class="w-full max-w-4xl @lg/main:w-[65%]">
                            <input class="profile_edit_input w-full @lg/main:w-1/2" type="email" name="email" id="email" placeholder="e.g., john.doe@example.com">
                        </div>
                    </div>
                    <div class="flex flex-col items-center justify-between gap-3 @lg/main:flex-row @lg/main:gap-[4.5rem]">
                        <div class="w-full place-content-center @lg/main:w-[35%]">
                        ...
                        <div class="w-full max-w-4xl @lg/main:w-[65%]">
                            <input class="profile_edit_input w-full @lg/main:w-1/2" type="tel" name="contactnum" id="contactnum" placeholder="e.g., +63 912 345 6789">
                        </div>
                    </div>
                    <div class="flex flex-col items-center justify-between gap-3 @lg/main:flex-row @lg/main:gap-[4.5rem]">
                        <div class="w-full place-content-center @lg/main:w-[35%]">
                            <h6 class="text-base font-medium leading-relaxed tracking-wide">Address</h6>
                            <p class="text-sm text-gray-600 leading-tight"><em>Provide your complete physical location including building number, street name, and unit/apartment information.</em></p>
                        </div>
                        <div class="w-full max-w-4xl @lg/main:w-[65%]">
                            <textarea class="profile_edit_input w-full resize-none" name="address" id="address" cols="20" rows="3" placeholder="Type your full address"></textarea>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div class="p-5 bg-blue-100 rounded-xl space-y-8 @lg/main:space-y-14">
                    <div class="flex flex-col items-center justify-between gap-3 @lg/main:flex-row @lg/main:gap-[4.5rem]">
                        <div class="w-full place-content-center @lg/main:w-[35%]">
                            ...
                            <p class="text-sm text-gray-600 leading-tight"><em>Create the personal handle that you'll use to log in and access your account.</em></p>
                        </div>
                        <div class="w-full max-w-4xl @lg/main:w-[65%]">
                            <input class="profile_edit_input w-full @lg/main:w-1/2" type="text" name="username" id="username" placeholder="Enter a unique username">
                        </div>
                    </div>
                    <div class="flex flex-col items-center justify-between gap-3 @lg/main:flex-row @lg/main:gap-[4.5rem]">
                        <div class="w-full place-content-center @lg/main:w-[35%]">
                            <h6 class="text-base font-medium leading-relaxed tracking-wide">Password</h6>
                            <p class="text-sm text-gray-600 leading-tight"><em>Set up your personal security phrase with at least 8 characters.</em></p>
                        </div>
                        <div class="w-full max-w-4xl @lg/main:w-[65%]">
                            <div class="relative w-full @lg/main:w-1/2">
                                <input class="profile_edit_input w-full pr-9" type="password" name="password" id="password" placeholder="Enter a strong password">
                                <div class="group/seepwd absolute top-0 right-0 h-full grid place-items-center aspect-square rounded-r-lg bg-sky-100 cursor-pointer transition-colors hover:bg-sky-200">
                                    <svg class="size-5 fill-sky-700 group-hover/seepwd:fill-sky-800 group-active/seepwd:fill-sky-900" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--><path d="M288 32c-80.8 0-145.5 36.8-192.6 80.6C48.6 156 17.3 208 2.5 243.7c-3.3 7.9-3.3 16.7 0 24.6C17.3 304 48.6 356 95.4 399.4C142.5 443.2 207.2 480 288 480s145.5-36.8 192.6-80.6c46.8-43.5 78.1-95.4 93-131.1c3.3-7.9 3.3-16.7 0-24.6c-14.9-35.7-46.2-87.7-93-131.1C433.5 68.8 368.8 32 288 32zM144 256a144 144 0 1 1 288 0 144 144 0 1 1 -288 0zm144-64c0 35.3-28.7 64-64 64c-7.1 0-13.9-1.2-20.3-3.3c-5.5-1.8-11.9 1.6-11.7 7.4c.3 6.9 1.3 13.8 3.2 20.7c13.7 51.2 66.4 81.6 117.6 67.9s81.6-66.4 67.9-117.6c-11.1-41.5-47.8-69.4-88.6-71.1c-5.8-.2-9.2 6.1-7.4 11.7c2.1 6.4 3.3 13.2 3.3 20.3z"/></svg>
                                    {{-- Eye slash icon --}}
                    ...
                    <div class="flex flex-col items-center justify-between gap-3 @lg/main:flex-row @lg/main:gap-[4.5rem]">
                        <div class="w-full place-content-center @lg/main:w-[35%]">
                            ...
                            <p class="text-sm text-gray-600 leading-tight"><em>Re-enter your password exactly as above to confirm.</em></p>
                        </div>
                        <div class="w-full max-w-4xl @lg/main:w-[65%]">
                            <div class="relative w-full @lg/main:w-1/2">
                                <input class="profile_edit_input w-full pr-9" type="password" name="confpassword" id="confpassword" placeholder="Confirm your password">
                                <div class="group/seepwd absolute top-0 right-0 h-full grid place-items-center aspect-square rounded-r-lg bg-sky-100 cursor-pointer transition-colors hover:bg-sky-200">
                                    <svg class="size-5 fill-sky-700 group-hover/seepwd:fill-sky-800 group-active/seepwd:fill-sky-900" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--><path d="M288 32c-80.8 0-145.5 36.8-192.6 80.6C48.6 156 17.3 208 2.5 243.7c-3.3 7.9-3.3 16.7 0 24.6C17.3 304 48.6 356 95.4 399.4C142.5 443.2 207.2 480 288 480s145.5-36.8 192.6-80.6c46.8-43.5 78.1-95.4 93-131.1c3.3-7.9 3.3-16.7 0-24.6c-14.9-35.7-46.2-87.7-93-131.1C433.5 68.8 368.8 32 288 32zM144 256a144 144 0 1 1 288 0 144 144 0 1 1 -288 0zm144-64c0 35.3-28.7 64-64 64c-7.1 0-13.9-1.2-20.3-3.3c-5.5-1.8-11.9 1.6-11.7 7.4c.3 6.9 1.3 13.8 3.2 20.7c13.7 51.2 66.4 81.6 117.6 67.9s81.6-66.4 67.9-117.6c-11.1-41.5-47.8-69.4-88.6-71.1c-5.8-.2-9.2 6.1-7.4 11.7c2.1 6.4 3.3 13.2 3.3 20.3z"/></svg>
                                    {{-- Eye slash icon --}}
                                    {{-- <svg class="size-5 fill-sky-700 group-hover/seepwd:fill-sky-800 group-active/seepwd:fill-sky-900" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--><path d="M38.8 5.1C28.4-3.1 13.3-1.2 5.1 9.2S-1.2 34.7 9.2 42.9l592 464c10.4 8.2 25.5 6.3 33.7-4.1s6.3-25.5-4.1-33.7L525.6 386.7c39.6-40.6 66.4-86.1 79.9-118.4c3.3-7.9 3.3-16.7 0-24.6c-14.9-35.7-46.2-87.7-93-131.1C465.5 68.8 400.8 32 320 32c-68.2 0-125 26.3-169.3 60.8L38.8 5.1zM223.1 149.5C248.6 126.2 282.7 112 320 112c79.5 0 144 64.5 144 144c0 24.9-6.3 48.3-17.4 68.7L408 294.5c8.4-19.3 10.6-41.4 4.8-63.3c-11.1-41.5-47.8-69.4-88.6-71.1c-5.8-.2-9.2 6.1-7.4 11.7c2.1 6.4 3.3 13.2 3.3 20.3c0 10.2-2.4 19.8-6.6 28.3l-90.3-70.8zM373 389.9c-16.4 6.5-34.3 10.1-53 10.1c-79.5 0-144-64.5-144-144c0-6.9 .5-13.6 1.4-20.2L83.1 161.5C60.3 191.2 44 220.8 34.5 243.7c-3.3 7.9-3.3 16.7 0 24.6c14.9 35.7 46.2 87.7 93 131.1C174.5 443.2 239.2 480 320 480c47.8 0 89.9-12.9 126.2-32.5L373 389.9z"/></svg> --}}
            ...
            <div class="flex justify-end gap-4">
                <button class="px-5 py-2 rounded-lg ring-0 ring-gray-300 hover:bg-gray-200 hover:ring-2 active:bg-gray-300">Cancel</button>
                <button type="submit" class="flex gap-1 justify-center items-center px-6 py-2 bg-amber-300 rounded-lg ring-0 ring-amber-500 transition-colors hover:ring-1 hover:bg-amber-400 hover:shadow-xl active:bg-amber-500">
                    <p>Save changes</p>
                    <svg class="size-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--><path d="M246.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-9.2-9.2-22.9-11.9-34.9-6.9s-19.8 16.6-19.8 29.6l0 256c0 12.9 7.8 24.6 19.8 29.6s25.7 2.2 34.9-6.9l128-128z"/></svg>
                </button>
            </div>
        </main>
    </div>
