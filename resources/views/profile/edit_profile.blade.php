                                ...
                                <div class="flex flex-row w-full gap-x-5">
                                    ...
                                    <div class="space-y-1 flex flex-col w-[33%]">
                                        ...
                                        <select class="profile_edit_input" type="text" name="employee_suffix" required>
                                            <option value="" disabled selected class="italic text-gray-400">Select options</option>
                                ...
                                <div class="flex flex-row w-full gap-x-5">
                                    <div class="space-y-1 flex flex-col w-[33%]">
                                        ...
                                        <select class="profile_edit_input" type="text" name="employee_gender" required>
                                            <option value="" disabled selected class="italic text-gray-400">Select your Gender</option>
                            ...
                            <div class="flex flex-row w-full gap-x-5">
                                <div class="space-y-1 flex flex-col w-[33%]">
                                    ...
                                    <select class="profile_edit_input hide-scrollbar" type="text" name="employee_religion" required>
                                        <option value="" disabled selected class="italic text-gray-400">Select your Religion</option>
                                ...
                                <div class="flex flex-col w-full gap-y-2">
                                    <div class="flex flex-row gap-x-5">
                                        <div class="space-y-1 flex flex-col w-[25%]">
                                            ...
                                            <input class="w-full profile_edit_input" type="email" name="employee_personal_email"
                                        ...
                                        <div class="flex flex-col space-y-1 w-[25%]">
                                            ...
                                            <input class="flex w-full profile_edit_input" type="number" name="employee_contact_no1"
                                        ...
                                        <div class="flex flex-col space-y-1 w-[25%]">
                                            ...
                                            <input class="flex w-full profile_edit_input" type="number" name="employee_contact_no2"
                                                placeholder="e.g., +63 912 345 6789">
                                        </div>
                                        <div class="flex flex-col space-y-1 w-[25%]">
                                            <label class="hidden text-aapblue @lg/main:block " for="viberName">Viber Number</label>
                                            <input class="flex w-full profile_edit_input" type="number" name="employee_viber_number"
                                                placeholder="e.g., +63 912 345 6789" required>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="flex flex-row w-full gap-x-5">
                                <div class="flex flex-col w-[50%] gap-y-3">
                                    ...
                                    <div class="flex flex-col space-y-1">
                                        ...
                                        <input class="flex w-full profile_edit_input" type="text" name="employee_school_attended"
                                    ...
                                    <div class="flex flex-col gap-y-4">
                                        <div class="flex flex-row w-full gap-x-5">
                                            <div class="flex flex-col space-y-1 w-[50%]">
                                                ...
                                                <input class="flex w-full profile_edit_input" type="text" name="employee_job_position"
                                        ...
                                        <div class="flex flex-row w-full gap-x-5">
                                            <div class="flex flex-col space-y-1 w-[50%]">
                                                ...
                                                <input class="flex w-full profile_edit_input" type="text" name="employee_company_email"
                                                    placeholder="e.g., University of Caloocan City" required>
                                            </div>
                                            <div class="flex flex-col space-y-1 w-[50%]">
                                                <div class="flex flex-row w-full gap-x-2">
                            ...
                            <div class="flex flex-row items-center justify-center w-full gap-x-5">
                                <div class="flex flex-col w-[50%] gap-y-3">
                                    <div class="flex flex-col w-full space-y-1">
                                        ...
                                        <input class="h-10 border border-blue-400 rounded-lg file:h-10 file:w-32" type="file" accept=".pdf,.jpg,.jpeg,.png" id="file-upload" name="marriage_certificate_path" required>
                                    </div>
                                    <div class="flex flex-col w-full space-y-1">
                                        <div class="flex flex-row w-full gap-x-2">
                                        ...
                                        <input class="h-10 border border-blue-400 rounded-lg file:h-10 file:w-32" type="file" accept=".pdf,.jpg,.jpeg,.png" id="file-upload" name="parents_birth_certificate_path[]" multiple required>
                                    </div>
                                    <div class="flex flex-col w-full space-y-1">
                                        ...
                                        <input class="h-10 border border-blue-400 rounded-lg file:h-10 file:w-32" type="file" accept=".pdf,.jpg,.jpeg,.png" id="file-upload" name="pagibig_mdf_path[]" multiple required>
                                    </div>
                                </div>
                            ...
                            <div class="flex flex-col w-full gap-y-3">
                                <div class="flex flex-row items-center justify-center w-full gap-x-5">
                                    <div class="flex flex-col space-y-1 w-[50%]">
                                        ...
                                        <input type="number" name="employee_children_count" placeholder="e.g., 2" class="flex w-full profile_edit_input" required>
                                    </div>
                                    <div class="flex flex-col space-y-1 w-[50%]">
                                        <div class="flex flex-col w-full gap-x-2">
                                        ...
                                        <input class="h-10 border border-blue-400 rounded-lg file:h-10 file:w-32" type="file" accept=".pdf,.jpg,.jpeg,.png" id="file-upload" name="children_birth_certificates_path[]" multiple required>
                                    </div>
                                </div>
                                        ...
                                        <div class="flex flex-col w-full gap-4 p-6 border border-blue-400 rounded-lg child-input">
                                            ...
                                            <div class="flex flex-row w-full gap-x-5">
                                                <div class="space-y-1 flex flex-col w-[50%]">
                                                    ...
                                                    <input type="text" name="employee_children_1_details[0][name]" id="childFullName" placeholder="e.g., Juan Dela Cruz" class="flex w-full profile_edit_input" required>
                                                </div>
                                                {{-- <div class="space-y-1 flex flex-col w-[33%]">
                                                    <label class="hidden text-aapblue @lg/main:block" for="middle">Age</label>
                                                    <input type="text" name="employee_children_1_age[0][age]" id="childAge" placeholder="e.g., 19 years old" class="flex w-full profile_edit_input" required>
                                                </div> --}}
                                                <div class="space-y-1 flex flex-col w-[50%]">
                                ...
                                <div class="flex flex-row items-center justify-start w-full gap-x-5">
                                    <div class="flex flex-col space-y-1 w-[49%]">
                                        ...
                                        <input class="h-10 border border-blue-400 rounded-lg file:h-10 file:w-32" type="file" id="file-upload" accept=".pdf,.jpg,.jpeg,.png" name="parents_birth_certificate_dependents_path[]" multiple required>
                                    </div>
                                </div>
                                        ...
                                        <div class="flex flex-col w-full gap-4 p-6 border border-blue-400 rounded-lg child-input">
                                            ...
                                            <div class="flex flex-row w-full gap-x-5">
                                                <div class="space-y-1 flex flex-col w-[50%]">
                                                    ...
                                                    <input type="text" name="employee_parents_1_details" placeholder="e.g., Juan Dela Cruz" class="flex w-full profile_edit_input" required>
                                                </div>
                                                {{-- <div class="space-y-1 flex flex-col w-[50%]">
                                                    <label class="hidden text-aapblue @lg/main:block" for="fatherAge">Age</label>
                                                    <input type="text" name="employee_parents_1_age" placeholder="e.g., 19 years old" class="flex w-full profile_edit_input" required>
                                                </div> --}}
                                                <div class="space-y-1 flex flex-col w-[50%]">
                                        ...
                                        <div class="flex flex-col w-full gap-4 p-6 border border-blue-400 rounded-lg child-input">
                                            ...
                                            <div class="flex flex-row w-full gap-x-5">
                                                <div class="space-y-1 flex flex-col w-[50%]">
                                                    ...
                                                    <input type="text" name="employee_parents_2_details" placeholder="e.g., Juan Dela Cruz" class="flex w-full profile_edit_input" required>
                                                </div>
                                                {{-- <div class="space-y-1 flex flex-col w-[50%]">
                                                    <label class="hidden text-aapblue @lg/main:block" for="motherAge">Age</label>
                                                    <input type="text" name="employee_parents_2_age" placeholder="e.g., 19 years old" class="flex w-full profile_edit_input" required>
                                                </div> --}}
                                                <div class="space-y-1 flex flex-col w-[50%]">
                                ...
                                <div class="flex flex-col w-full gap-4 p-6 border border-blue-400 rounded-lg contact-input">
                                    ...
                                    <div class="flex flex-row w-full gap-x-5">
                                        <div class="space-y-1 flex flex-col w-[33%]">
                                            ...
                                            <input type="text" name="emergency_contact_1_name[0][name]" placeholder="e.g., Juan Dela Cruz" class="flex w-full profile_edit_input" required>
                                        </div>
                                        <div class="space-y-1 flex flex-col w-[33%]">
                                            <label class="hidden text-aapblue @lg/main:block" for="relationship">Relationship</label>
                                            <input type="text" name="emergency_contact_1_relationship[0][relationship]" placeholder="e.g., Brother" class="flex w-full profile_edit_input" required>
                                        </div>
                                        <div class="space-y-1 flex flex-col w-[33%]">
                                    ...
                                    <div class="flex flex-col w-full space-y-1">
                                        ...
                                        <textarea class="w-full resize-none profile_edit_input" name="emergency_contact_1_address[0][address]" id="contactAddress" cols="20" rows="3" 
        ...
        function addChildFields() {
            ...
            div.innerHTML = `
                <div class="flex items-center justify-between">
                    ...
                    <button type="button" onclick="deleteChildField(this)" class="text-sm font-bold text-red-500 hover:text-red-700">Delete</button>
                </div>
                
                <div class="flex flex-row w-full gap-x-5">
                    <div class="space-y-1 flex flex-col w-[50%]">
                        <label class="hidden text-aapblue @lg/main:block" for="middle">Full Name </label>
                        <input type="text" name="children[${childIndex}][name]" id="childFullName_${childIndex}" placeholder="e.g., Juan Dela Cruz" class="flex w-full profile_edit_input">
                    </div>
                    <div class="space-y-1 flex flex-col w-[50%]">
                        <label class="hidden text-aapblue @lg/main:block" for="middle">Age</label>
                        <input type="text" name="children[${childIndex}][age]" id="childAge_${childIndex}" placeholder="e.g., 19 years old" class="flex w-full profile_edit_input">
                    </div>
                </div>
