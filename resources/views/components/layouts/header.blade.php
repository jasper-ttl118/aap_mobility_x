...
// dd($modules_access);
@endphp
<div class="fixed z-10 flex flex-row items-center justify-between w-full h-12 px-4 mb-6 bg-white shadow-lg">
    ...
    <div class="flex flex-row items-center space-x-4">
        <a href="#" onmouseenter="playHoverSound()" onclick="playNotificationSound()" class="text-[#151847] border-r-2 border-[#151847] ">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="mx-3 duration-150 size-6 hover:animate-wiggle hover:text-yellow-400">
        ...
        <div class="relative inline-block text-left">
            <a href="#" class="text-[#151847] group transform duration-300 hover:text-white inline-flex" id="dropdownProfile">
                <div class="flex flex-row gap-2 group-hover:bg-[#151847] p-1 group-focus:border rounded-md group-focus:border-[#151847] group-focus:mx-0">
                    ...
                    <div class="flex flex-col items-start justify-center mt-1">
                        <span class="-my-2 font-bold uppercase text-md">{{ $user->employee->employee_firstname }} {{ $user->employee->employee_lastname }}</span>
            ...
            <div id="dropdownContent" class="absolute right-0 z-50 hidden w-full rounded-md">
