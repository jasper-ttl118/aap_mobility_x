...
// dd($modules_access);
@endphp
<div class="fixed flex flex-row w-full h-12 bg-white shadow-lg mb-6 z-0 items-center justify-between px-4">
    ...
    <div class="flex flex-row items-center space-x-4">
        <a href="#" class="text-[#151847] border-r-2 border-[#151847] ">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6 mx-3 hover:animate-wiggle duration-150">
        ...
        <div class="relative inline-block text-left">
            <a href="#" class="text-[#151847] group transform duration-300 hover:text-white inline-flex" id="dropdownProfile">
                <div class="flex flex-row gap-2 group-hover:bg-[#151847] rounded-md p-1">
            ...
            <div id="dropdownContent" class="hidden absolute bg-white w-full right-0 rounded-md shadow-lg z-50">
                <div class="">
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button class="w-full px-4 py-2 text-[#151847] hover:bg-[#151847] hover:text-white text-center font-bold text-md rounded-b-md">Logout</button>
                    </form>
                </div>
            </div>
        </div>
