<div class="flex justify-between">
    ...
    <div class="flex gap-x-4">
        <a href="#" class="border-2 p-1.5 px-4 py-2 bg-[#FFC628] text-sm text-center rounded-lg font-inter font-medium">Send To All Via Email</a>
        <a href="#" class="border-2 p-1.5 px-4 py-2 bg-[#FFC628] text-sm text-center rounded-lg font-inter font-medium">Send To All Via Mobile No.</a>
    </div>
</div>
